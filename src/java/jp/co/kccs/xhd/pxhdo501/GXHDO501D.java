...
@Named
@ViewScoped
public class GXHDO501D implements Serializable {
    
    private static final Logger LOGGER = Logger.getLogger(GXHDO501D.class.getName());
    /**
    ...
    */
    ...
    private boolean userAuthLogin() {
        ...
        String authParam = USER_AUTH_UPDATE_PARAM;
