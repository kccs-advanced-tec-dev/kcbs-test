...
public class GXHDO101B020 implements IFormLogic {
    ...
    private void setInputItemDataMainForm(ProcessData processData, SrBarrel1 srBarrel1Data) {
        ...
        // ﾎﾟｯﾄﾁｪｯｸ
        this.setItemData(processData, GXHDO101B020Const.POTCHECK, getSrBarrel1ItemData(GXHDO101B020Const.POTCHECK, srBarrel1Data));
        // 研磨時間
        ...
        // 備考3
        this.setItemData(processData, GXHDO101B020Const.BIKO3, getSrBarrel1ItemData(GXHDO101B020Const.BIKO3, srBarrel1Data));
        // 備考4
        this.setItemData(processData, GXHDO101B020Const.BIKO4, getSrBarrel1ItemData(GXHDO101B020Const.BIKO4, srBarrel1Data));
        // 備考5
        this.setItemData(processData, GXHDO101B020Const.BIKO5, getSrBarrel1ItemData(GXHDO101B020Const.BIKO5, srBarrel1Data));
        // 研磨時間単位
    ...
    private List<SrBarrel1> loadSrBarrel1(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
        ...
        String sql = "SELECT kojyo ,lotno ,edaban ,jissekino ,kcpno ,bkaisinichiji ,bsyuryonichiji ,bjyokensetteimode ,bjyokensyusokudo ,"
                ...
                + " kenmajikantani ,'0' AS deleteflag, potcheck, biko3, biko4, biko5  "
                + "FROM sr_barrel1 "
        ...
        mapping.put("potcheck", "potcheck"); //ﾎﾟｯﾄﾁｪｯｸ
    ...
    private List<SrBarrel1> loadTmpSrBarrel1(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
        ...
        String sql = "SELECT kojyo ,lotno ,edaban ,jissekino ,kcpno ,bkaisinichiji ,bsyuryonichiji ,bjyokensetteimode ,bjyokensyusokudo ,"
                ...
                + " kansyuryonichiji ,kantantosya ,mediasenbetu ,bpotno2 ,keinichiji ,ukeirekosuu ,tanijyuryo ,ryohinkosuu ,"
                + " furyosuu ,budomari ,keitantosya ,biko1 ,biko2 ,torokunichiji ,kosinNichiji ,kenma ,kenmazairyo ,"
                + " kenmazaisyurui ,tamaishisyurui ,tamaishiryou ,gaikancheck ,StartKakuninsyacode ,EndTantosyacode ,revision ,kenmajikantani ,deleteflag, potcheck, biko3, biko4, biko5  "
                + "FROM tmp_sr_barrel1 "
    ...
    private void insertTmpSrBarrel1(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev, int deleteflag,
        ...
        String sql = "INSERT INTO tmp_sr_barrel1 ("
                ...
                + ",kenmazairyo,kenmazaisyurui,tamaishisyurui,tamaishiryou,gaikancheck,StartKakuninsyacode,EndTantosyacode,revision,kenmajikantani,deleteflag, potcheck, biko3, biko4, biko5"
                + ") VALUES ("
                + " ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, ?, ?, ?, ? ) ";
    ...
    private void updateTmpSrBarrel1(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev, String jotaiFlg, BigDecimal newRev,
        ...
        String sql = "UPDATE tmp_sr_barrel1 SET "
                ...
                + "revision = ?,kenmajikantani = ?,deleteflag = ?, potcheck = ?, biko3 = ?, biko4 = ?, biko5 = ?  "
    ...
    private List<Object> setUpdateParameterTmpSrBarrel1(boolean isInsert, BigDecimal newRev, int deleteflag, String kojyo,
        ...
        params.add(deleteflag); //削除ﾌﾗｸﾞ
         params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B020Const.POTCHECK, srBarrel1Data))); // ﾎﾟｯﾄﾁｪｯｸ
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B020Const.BIKO3, srBarrel1Data))); // 備考3
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B020Const.BIKO4, srBarrel1Data))); // 備考4
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B020Const.BIKO5, srBarrel1Data))); // 備考5
    ...
    private void insertSrBarrel1(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev,
        ...
        String sql = "INSERT INTO sr_barrel1 ("
                ...
                + " kansyuryonichiji ,kantantosya ,mediasenbetu ,bpotno2 ,keinichiji ,ukeirekosuu ,tanijyuryo ,ryohinkosuu ,"
                + " furyosuu ,budomari ,keitantosya ,biko1 ,biko2 ,torokunichiji ,kosinNichiji ,kenma ,kenmazairyo ,"
                + " kenmazaisyurui ,tamaishisyurui ,tamaishiryou ,gaikancheck ,StartKakuninsyacode ,EndTantosyacode ,revision,kenmajikantani, potcheck, biko3, biko4, biko5 "
                + ") VALUES ("
                + " ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, ?, ?, ?, ? ) ";
    ...
    private List<Object> setUpdateParameterSrBarrel1(boolean isInsert, BigDecimal newRev, String kojyo, String lotNo, String edaban,
        ...
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B020Const.POTCHECK, srBarrel1Data))); // ﾎﾟｯﾄﾁｪｯｸ
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B020Const.BIKO3, srBarrel1Data))); // 備考3
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B020Const.BIKO4, srBarrel1Data))); // 備考4
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B020Const.BIKO5, srBarrel1Data))); // 備考5
    ...
    public ProcessData setShuryouDateTimeKeisan(ProcessData processData) {
        ...
        try {
            ...
            if (StringUtil.isEmpty(itemEndDay.getValue()) && StringUtil.isEmpty(itemEndTime.getValue())) {
                ...
                //     ・開始日
                //     ・開始時刻
                FXHDD01 itemBjikan = getItemRow(processData.getItemList(), GXHDO101B020Const.BJIKAN);
                ...
                //   当処理(【終了日時計算】ﾎﾞﾀﾝ押下時)を終了する。
                if (!StringUtil.isEmpty(itemBjikan.getValue()) && !StringUtil.isEmpty(itemKenmajikantani.getValue()) && 
                        !StringUtil.isEmpty(itemStartDay.getValue()) && !StringUtil.isEmpty(itemStartTime.getValue())) {
                    
                     //研磨時間
                    String kenmajikan = StringUtil.nullToBlank(getItemData(processData.getItemList(), GXHDO101B020Const.BJIKAN, null));

                    //  2.【研磨時間】の入力値が数値変換できない場合。
                    //   当処理(【終了日時計算】ﾎﾞﾀﾝ押下時)を終了する。
                    BigDecimal decKenmajikan = new BigDecimal(kenmajikan);
                    //  3.【研磨時間】の入力値が0もしくは0以下 だった場合。
                    if(0 <= BigDecimal.ZERO.compareTo(decKenmajikan)){
                        // 当処理(【終了日時計算】ﾎﾞﾀﾝ押下時)を終了する。
                        return processData;
                    }
    ...
    private String getSrBarrel1ItemData(String itemId, SrBarrel1 srBarrel1Data) {
        switch (itemId) {
            ...
            // ﾎﾟｯﾄﾁｪｯｸ
            case GXHDO101B020Const.POTCHECK:
                return StringUtil.nullToBlank(srBarrel1Data.getPotcheck());
            // 備考3
            case GXHDO101B020Const.BIKO3:
                return StringUtil.nullToBlank(srBarrel1Data.getBiko3());
            // 備考4
            case GXHDO101B020Const.BIKO4:
                return StringUtil.nullToBlank(srBarrel1Data.getBiko4());
            // 備考5
            case GXHDO101B020Const.BIKO5:
                return StringUtil.nullToBlank(srBarrel1Data.getBiko5());
            // 研磨時間単位
    ...
    private void insertDeleteDataTmpSrBarrel1(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev, int deleteflag,
        ...
        String sql = "INSERT INTO tmp_sr_barrel1 ("
                ...
                +  " kenmazaisyurui ,tamaishisyurui ,tamaishiryou ,gaikancheck ,StartKakuninsyacode ,EndTantosyacode ,? ,kenmajikantani,?, potcheck, biko3, biko4, biko5  "
                + " FROM sr_barrel1 "
                + " WHERE kojyo = ? AND lotno = ? AND edaban = ? AND jissekino = ? ";
