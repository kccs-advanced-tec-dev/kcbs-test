...
public class GXHDO102C016Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrSlipSlipkokeibunsokutei subSrSlipSlipkokeibunsokuteiData) {
        ...
        int index = 0;
        // サブ画面の調合規格
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getTyogouryoukikaku()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
        // サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getTyogouzanryou()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
    ...
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrSlipSlipkokeibunsokutei subSrSlipSlipkokeibunsokuteiData) {
        ...
        // サブ画面の部材①タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getZairyohinmei()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
        // サブ画面の部材①タブの部材在庫No1
        ...
        // サブ画面の部材①タブの部材在庫品名1
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "1", true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getBuzaihinmei1()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材①タブの調合量1_1
    ...
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrSlipSlipkokeibunsokutei subSrSlipSlipkokeibunsokuteiData) {
        ...
        // サブ画面の部材②タブの材料品名
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getZairyohinmei()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
        // サブ画面の部材②タブの部材在庫No1
        ...
        // サブ画面の部材②タブの部材在庫品名1
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "2", true, StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getBuzaihinmei2()), StringUtil.nullToBlank(subSrSlipSlipkokeibunsokuteiData.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材②タブの調合量2_1
