...
public class GXHDO102B029 implements IFormLogic {
    ...
    public ProcessData openC014SubGamen1(ProcessData processData) {
        ...
        return openC014SubGamen(processData, 1, returnItemIdList, GXHDO102B029Const.YOUZAI1_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC014SubGamen2(ProcessData processData) {
        ...
        return openC014SubGamen(processData, 2, returnItemIdList, GXHDO102B029Const.YOUZAI2_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC014SubGamen3(ProcessData processData) {
        ...
        return openC014SubGamen(processData, 3, returnItemIdList, GXHDO102B029Const.YOUZAI3_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC014SubGamen4(ProcessData processData) {
        ...
        return openC014SubGamen(processData, 4, returnItemIdList, GXHDO102B029Const.YOUZAI4_TYOUGOURYOUKIKAKU);
    }
     ...
     * @return 処理制御データ
     */
    public ProcessData openC014SubGamen(ProcessData processData, int zairyokubun, List<String> returnItemIdList,String itemTyougouryoukikaku) {
        try {
            // 「秤量号機」
    ...
    private void setInputItemDataSubFormC014(ProcessData processData, List<SubSrSlipYouzaihyouryouTounyuuSiropori> subSrSlipYouzaihyouryouTounyuuSiroporiList) {
        ...
        if (subSrSlipYouzaihyouryouTounyuuSiroporiList == null) {
            ...
            subgamen1.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B029Const.YOUZAI1_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤1_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen2.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B029Const.YOUZAI2_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤2_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen3.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B029Const.YOUZAI3_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤3_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen4.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B029Const.YOUZAI4_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤4_調合量規格情報ﾊﾟﾀｰﾝ
