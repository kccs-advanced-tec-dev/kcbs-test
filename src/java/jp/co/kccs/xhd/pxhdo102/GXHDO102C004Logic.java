...
public class GXHDO102C004Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrTenkaTyogo subSrTenkaTyogoData) {
        ...
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(subSrTenkaTyogoData.getTyogouryoukikaku()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
        // 【材料品名1】ﾘﾝｸ押下時、サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(subSrTenkaTyogoData.getTyogouzanryou()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
    ...
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrTenkaTyogo subSrTenkaTyogoData) {
        ...
        // サブ画面の部材①タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrTenkaTyogoData.getZairyohinmei()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
        // サブ画面の部材①タブの部材在庫No1
        ...
        // サブ画面の部材①タブの部材在庫品名1
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "1", true, StringUtil.nullToBlank(subSrTenkaTyogoData.getBuzaihinmei1()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材①タブの調合量1_1
    ...
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrTenkaTyogo subSrTenkaTyogoData) {
        ...
        // サブ画面の部材②タブの材料品名
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrTenkaTyogoData.getZairyohinmei()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
        // サブ画面の部材②タブの部材在庫No1
        ...
        // サブ画面の部材②タブの部材在庫品名1
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "2", true, StringUtil.nullToBlank(subSrTenkaTyogoData.getBuzaihinmei2()), StringUtil.nullToBlank(subSrTenkaTyogoData.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材②タブの調合量2_1
