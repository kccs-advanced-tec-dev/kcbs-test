...
public class GXHDO102C008Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrBinderPowder subSrBinderPowder) {
        ...
        int index = 0;
        // サブ画面の調合規格
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(subSrBinderPowder.getTyogouryoukikaku()), index));
        // サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(subSrBinderPowder.getTyogouzanryou()), index));
    ...
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrBinderPowder subSrBinderPowder) {
        ...
        // サブ画面の部材①タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrBinderPowder.getZairyohinmei()), index));
        // サブ画面の部材①タブの部材在庫No1
        ...
        // サブ画面の部材①タブの部材在庫品名1
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "1", true, StringUtil.nullToBlank(subSrBinderPowder.getBuzaihinmei1()), index));
        index += 1;
        // サブ画面の部材①タブの調合量1_1
    ...
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrBinderPowder subSrBinderPowder) {
        ...
        // サブ画面の部材②タブの材料品名
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrBinderPowder.getZairyohinmei()), index));
        // サブ画面の部材②タブの部材在庫No1
        ...
        // サブ画面の部材②タブの部材在庫品名1
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "2", true, StringUtil.nullToBlank(subSrBinderPowder.getBuzaihinmei2()), index));
        index += 1;
        // サブ画面の部材②タブの調合量2_1
