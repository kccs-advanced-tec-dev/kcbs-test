...
//        processDate.setMethod("");
//        //誤差率計算
//        calcGosaritsu(processDate);
//        //不良率計算
//        calcMachineFuryoritsu(processDate);
//        
//        return processDate;
//    }
//
...
//     * @param processDate 処理制御データ
//     */
//    private void calcGosaritsu(ProcessData processDate) {
//        //BIN1 誤差率計算
...
//     * @param processDate 処理制御データ
//     */
//    private void calcMachineFuryoritsu(ProcessData processDate) {
//        // 送り良品数
//        FXHDD01 itemOkuriRryohinsu = getItemRow(processDate.getItemList(), GXHDO101B040Const.SEIHIN_OKURI_RYOHINSU);
//        //BIN1 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN1_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN1_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN2 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN2_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN2_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN3 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN3_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN3_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN4 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN4_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN4_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN5 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN5_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN5_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN6 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN6_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN6_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN7 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN7_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN7_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN8 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN8_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN8_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //BIN9 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN9_K_MACHINE_FURYORITSU, GXHDO101B040Const.SET_BIN9_K_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//        //落下 マシン不良率計算
//        calcMachineFuryoritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_RAKKA_MACHINE_FURYORITSU, GXHDO101B040Const.SET_RAKKA_KEIRYOGO_SURYO, itemOkuriRryohinsu);
//    }
//
//    /**
//     * マシン不良率計算(ﾒｲﾝ処理)
...
//     * @param processDate 処理制御データ
//     */
//    private void calcShinFuryoritsu(ProcessData processDate) {
//        //BIN1 誤差率計算
//        calcGosaritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN1_SHIN_FURYORITSU, GXHDO101B040Const.SET_BIN1_KEIRYOGO_SURYO, GXHDO101B040Const.SET_BIN1_COUNTER_SU);
//        //BIN2 誤差率計算
//        calcGosaritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN2_GOSARITSU, GXHDO101B040Const.SET_BIN2_KEIRYOGO_SURYO, GXHDO101B040Const.SET_BIN2_COUNTER_SU);
//        //BIN3 誤差率計算
//        calcGosaritsuMain(processDate.getItemListEx(), GXHDO101B040Const.SET_BIN3_GOSARITSU, GXHDO101B040Const.SET_BIN3_KEIRYOGO_SURYO, GXHDO101B040Const.SET_BIN3_COUNTER_SU);
...
//     * @param counterSuId カウンター数ID
//     */
//    private void calcShinFuryoritsuMain(List<FXHDD01> itemListEx, String gosaritsuId, String keiryogoSuryoId, String counterSuId) {
//        try {
//            FXHDD01 itemGosaritsu = getItemRow(itemListEx, gosaritsuId); //誤差率
//            FXHDD01 itemKeiryogoSuryo = getItemRow(itemListEx, keiryogoSuryoId); //計量後数量
//            FXHDD01 itemCounterSu = getItemRow(itemListEx, counterSuId); //カウンター数
