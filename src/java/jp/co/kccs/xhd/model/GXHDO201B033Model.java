 ...
 */
/**
 * 外部電極・外部電極洗浄(ﾊﾞﾚﾙ)履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2019/11/07
 */
public class GXHDO201B033Model implements Serializable{
    ...
    /** 回転数 */
    private BigDecimal kaitensuu = null;
    ...
    /**
     * @param methanolkoukanpotruikeisuu methanolkoukanpotruikeisuu
     */
