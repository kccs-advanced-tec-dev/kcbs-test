 ...
 */
/**
 * GXHDO102C010(誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力)
 *
 * @author KCSS K.Jo
 * @since 2021/11/10
 */
@ManagedBean(name = "beanGXHDO102C010")
@SessionScoped
public class GXHDO102C010 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C010.class.getName());
    ...
    /**
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ
     */
    private GXHDO102C010Model gxhdO102c010Model;

    /**
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C010Model gxhdO102c010ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C010Logic.setSubgamenDataFromView(this.getGxhdO102c010ModelView(), this.getGxhdO102c010Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C010Model.SubGamenData showsubgamendata = this.getGxhdO102c010ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C010Logic.clearBackColor(this.getGxhdO102c010ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c010ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C010Logic.calcTyogouzanryou(this.getGxhdO102c010ModelView());
        GXHDO102C010Logic.setShowsubgamendataFromView(this.getGxhdO102c010ModelView(), this.getGxhdO102c010Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c010ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c010ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C010Model gxhdo102c010model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面
     * @param errorId エラーID
     ...
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ
     *
     * @return the gxhdO102c010Model
     */
    public GXHDO102C010Model getGxhdO102c010Model() {
     ...
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ
     *
     * @param gxhdO102c010Model the gxhdO102c010Model to set
     */
    public void setGxhdO102c010Model(GXHDO102C010Model gxhdO102c010Model) {
        this.gxhdO102c010Model = gxhdO102c010Model;
    }

    /**
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c010ModelView
     */
    public GXHDO102C010Model getGxhdO102c010ModelView() {
        return gxhdO102c010ModelView;
    }

    /**
     * 誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c010ModelView the gxhdO102c010ModelView to set
     */
    public void setGxhdO102c010ModelView(GXHDO102C010Model gxhdO102c010ModelView) {
        this.gxhdO102c010ModelView = gxhdO102c010ModelView;
    }
}
