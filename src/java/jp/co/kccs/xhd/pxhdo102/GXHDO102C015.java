 ...
 */
/**
 * GXHDO102C015(ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力)
 *
 * @author KCSS K.Jo
 * @since 2021/12/10
 */
@ManagedBean(name = "beanGXHDO102C015")
@SessionScoped
public class GXHDO102C015 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C015.class.getName());
    ...
    /**
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ
     */
    private GXHDO102C015Model gxhdO102c015Model;

    /**
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C015Model gxhdO102c015ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C015Logic.setSubgamenDataFromView(this.getGxhdO102c015ModelView(), this.getGxhdO102c015Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C015Model.SubGamenData showsubgamendata = this.getGxhdO102c015ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C015Logic.clearBackColor(this.getGxhdO102c015ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c015ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C015Logic.calcTyogouzanryou(this.getGxhdO102c015ModelView());
        GXHDO102C015Logic.setShowsubgamendataFromView(this.getGxhdO102c015ModelView(), this.getGxhdO102c015Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c015ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c015ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C015Model gxhdo102c015model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面
     * @param errorId エラーID
     ...
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ
     *
     * @return the gxhdO102c015Model
     */
    public GXHDO102C015Model getGxhdO102c015Model() {
     ...
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ
     *
     * @param gxhdO102c015Model the gxhdO102c015Model to set
     */
    public void setGxhdO102c015Model(GXHDO102C015Model gxhdO102c015Model) {
        this.gxhdO102c015Model = gxhdO102c015Model;
    }

    /**
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c015ModelView
     */
    public GXHDO102C015Model getGxhdO102c015ModelView() {
        return gxhdO102c015ModelView;
    }

    /**
     * ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c015ModelView the gxhdO102c015ModelView to set
     */
    public void setGxhdO102c015ModelView(GXHDO102C015Model gxhdO102c015ModelView) {
        this.gxhdO102c015ModelView = gxhdO102c015ModelView;
    }
}
