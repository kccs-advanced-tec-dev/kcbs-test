 ...
 */
/**
 * GXHDO102C013(ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)入力)
 *
 * @author KCSS K.Jo
 * @since 2021/12/06
 */
@ManagedBean(name = "beanGXHDO102C013")
@SessionScoped
public class GXHDO102C013 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C013.class.getName());
    ...
    /**
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ
     */
    private GXHDO102C013Model gxhdO102c013Model;

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ(表示制御用)
     */
    private GXHDO102C013Model gxhdO102c013ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C013Logic.setSubgamenDataFromView(this.getGxhdO102c013ModelView(), this.getGxhdO102c013Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C013Model.SubGamenData showsubgamendata = this.getGxhdO102c013ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C013Logic.clearBackColor(this.getGxhdO102c013ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c013ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器))入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C013Logic.calcTyogouzanryou(this.getGxhdO102c013ModelView());
        GXHDO102C013Logic.setShowsubgamendataFromView(this.getGxhdO102c013ModelView(), this.getGxhdO102c013Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c013ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c013ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C013Model gxhdo102c013model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面
     * @param errorId エラーID
     ...
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ
     *
     * @return the gxhdO102c013Model
     */
    public GXHDO102C013Model getGxhdO102c013Model() {
     ...
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ
     *
     * @param gxhdO102c013Model the gxhdO102c013Model to set
     */
    public void setGxhdO102c013Model(GXHDO102C013Model gxhdO102c013Model) {
        this.gxhdO102c013Model = gxhdO102c013Model;
    }

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ(表示制御用)
     *
     * @return the gxhdO102c013ModelView
     */
    public GXHDO102C013Model getGxhdO102c013ModelView() {
        return gxhdO102c013ModelView;
    }

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用データ(表示制御用)
     *
     * @param gxhdO102c013ModelView the gxhdO102c013ModelView to set
     */
    public void setGxhdO102c013ModelView(GXHDO102C013Model gxhdO102c013ModelView) {
        this.gxhdO102c013ModelView = gxhdO102c013ModelView;
    }
}
