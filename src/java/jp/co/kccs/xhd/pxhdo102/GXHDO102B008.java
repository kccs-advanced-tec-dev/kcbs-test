...
public class GXHDO102B008 implements IFormLogic {
    ...
    public ProcessData openC004SubGamen1(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 1, returnItemIdList,GXHDO102B008Const.TENKAZAI1_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen2(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 2, returnItemIdList,GXHDO102B008Const.TENKAZAI2_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen3(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 3, returnItemIdList,GXHDO102B008Const.TENKAZAI3_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen4(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 4, returnItemIdList,GXHDO102B008Const.TENKAZAI4_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen5(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 5, returnItemIdList,GXHDO102B008Const.TENKAZAI5_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen6(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 6, returnItemIdList,GXHDO102B008Const.TENKAZAI6_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen7(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 7, returnItemIdList,GXHDO102B008Const.TENKAZAI7_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen8(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 8, returnItemIdList,GXHDO102B008Const.TENKAZAI8_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC004SubGamen9(ProcessData processData) {
        ...
        return openC004SubGamen(processData, 9, returnItemIdList,GXHDO102B008Const.TENKAZAI9_TYOUGOURYOUKIKAKU);
    }
     ...
     * @return 処理制御データ
     */
    public ProcessData openC004SubGamen(ProcessData processData, int zairyokubun, List<String> returnItemIdList,String itemTyougouryoukikaku) {
        try {
            // 「秤量号機」
    ...
    private void setInputItemDataSubFormC004(ProcessData processData, List<SubSrTenkaTyogo> subSrTenkaTyogoList) {
        ...
        if (subSrTenkaTyogoList == null) {
            ...
            subgamen1.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI1_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材1_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen2.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI2_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材2_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen3.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI3_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材3_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen4.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI4_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材4_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen5.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI5_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材5_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen6.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI6_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材6_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen7.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI7_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材7_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen8.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI8_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材8_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen9.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B008Const.TENKAZAI9_TYOUGOURYOUKIKAKU).getStandardPattern()); // 添加材9_調合量規格情報ﾊﾟﾀｰﾝ
