 ...
 */
/**
 * SR_SLIP_FP_SEIKEITANK(ｽﾘｯﾌﾟ作製・FP(成形ﾀﾝｸ))のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/12/21
 */
public class SrSlipFpSeikeitank {
     ...
     * 成形ﾀﾝｸ下部ﾊﾞﾙﾌﾞ閉
     */
    private Integer seikeitankkabuvalve;
     ...
     */
    public Integer getSeikeitankkabuvalve() {
     ...
     */
    public void setSeikeitankkabuvalve(Integer seikeitankkabuvalve) {
