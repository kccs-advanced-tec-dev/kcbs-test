 ...
 */
/**
 * SR_TENKA_GLASS(添加材ｽﾗﾘｰ作製・ｶﾞﾗｽ)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/09/26
 */
public class SrTenkaGlass {
     ...
     * 固形分測定日時
     */
    private Timestamp kokeibunsokuteinichiji;

    /**
     * 容器重量
     */
    private Integer youkijyuuryou;
     ...
     * 風袋重量
     */
    private BigDecimal fuutaijyuuryou;

    /**
     * 乾燥前重量
     */
    private BigDecimal kansoumaejyuuryou;
     ...
     * 乾燥後重量
     */
    private BigDecimal kansougojyuuryou;

    /**
     * 固形分
     */
    private BigDecimal kokeibun;
     ...
     * 固形分補正量
     */
    private Integer kokeibunhoseiryou;

    /**
     * 溶剤①添加量
     */
    private Integer youzai1tenkaryou;

    /**
     * 溶剤①調合量
     */
    private Integer youzai1tyougouryou;

    /**
     * 溶剤②添加量
     */
    private Integer youzai2tenkaryou;

    /**
     * 溶剤②調合量
     */
    private Integer youzai2tyougouryou;
     ...
     * 2回目乾燥前重量
     */
    private BigDecimal kansoumaejyuuryou2;
     ...
     * 2回目乾燥開始日時①
     */
    private Timestamp kansoukaisinichiji1_2;

    /**
     * 2回目乾燥終了日時①
     */
    private Timestamp kansousyuuryounichiji1_2;
     ...
     * 2回目乾燥後重量
     */
    private BigDecimal kansougojyuuryou2;

    /**
     * 2回目固形分
     */
    private BigDecimal kokeibun2;
     ...
     * ﾙﾂﾎﾞの種類
     *
     * @param rutubo the turubo to set
     */
    public void setRurubo(String rutubo) {
        this.rutubo = rutubo;
    }
     ...
     * 乾燥開始日時①
     *
     * @param kansoukaisinichiji1 the kansoukaisinichij1 to set
     */
     ...
     */
    public void setRurubo2(String rutubo2) {
