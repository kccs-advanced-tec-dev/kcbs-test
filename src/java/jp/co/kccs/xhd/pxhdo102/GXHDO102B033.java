...
public class GXHDO102B033 implements IFormLogic {
    ...
    public ProcessData openC016SubGamen1(ProcessData processData) {
        ...
        return openC016SubGamen(processData, 1, returnItemIdList);
    }
    ...
    public ProcessData openC016SubGamen2(ProcessData processData) {
        ...
        return openC016SubGamen(processData, 2, returnItemIdList);
    }
     ...
     * @return 処理制御データ
     */
    public ProcessData openC016SubGamen(ProcessData processData, int zairyokubun, List<String> returnItemIdList) {
        try {
            // 「秤量号機」
