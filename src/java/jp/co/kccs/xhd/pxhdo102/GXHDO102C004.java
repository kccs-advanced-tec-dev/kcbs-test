 ...
 */
/**
 * GXHDO102C004(添加材ｽﾗﾘｰ作製・添加材調合入力)
 *
 * @author KCSS wxf
 * @since 2021/10/18
 */
@ManagedBean(name = "beanGXHDO102C004")
@SessionScoped
public class GXHDO102C004 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C004.class.getName());
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ
     */
    private GXHDO102C004Model gxhdO102c004Model;

    /**
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C004Model gxhdO102c004ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C004Logic.setSubgamenDataFromView(this.getGxhdO102c004ModelView(), this.getGxhdO102c004Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C004Model.SubGamenData showsubgamendata = this.getGxhdO102c004ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C004Logic.clearBackColor(this.getGxhdO102c004ModelView());
        setErrorTabIndex(0);
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c004ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・添加材調合入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C004Logic.calcTyogouzanryou(this.getGxhdO102c004ModelView());
        GXHDO102C004Logic.setShowsubgamendataFromView(this.getGxhdO102c004ModelView(), this.getGxhdO102c004Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c004ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c004ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C004Model gxhdo102c004model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面
     * @param errorId エラーID
     ...
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ
     *
     * @return the gxhdO102c004Model
     */
    public GXHDO102C004Model getGxhdO102c004Model() {
     ...
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ
     *
     * @param gxhdO102c004Model the gxhdO102c004Model to set
     */
    public void setGxhdO102c004Model(GXHDO102C004Model gxhdO102c004Model) {
        this.gxhdO102c004Model = gxhdO102c004Model;
    }

    /**
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c004ModelView
     */
    public GXHDO102C004Model getGxhdO102c004ModelView() {
        return gxhdO102c004ModelView;
    }

    /**
     * 添加材ｽﾗﾘｰ作製・添加材調合入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c004ModelView the gxhdO102c004ModelView to set
     */
    public void setGxhdO102c004ModelView(GXHDO102C004Model gxhdO102c004ModelView) {
        this.gxhdO102c004ModelView = gxhdO102c004ModelView;
    }
}
