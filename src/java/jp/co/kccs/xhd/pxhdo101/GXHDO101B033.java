...
import jp.co.kccs.xhd.db.model.SrGdnijibarrel;
 ...
 */
/**
 * GXHDO101B033(外部電極・外部電極洗浄(ﾊﾞﾚﾙ))ロジック
 *
 * @author KCSS K.Jo
 * @since  2019/10/17
 */
public class GXHDO101B033 implements IFormLogic {
    ...
    public ProcessData initial(ProcessData processData) {
        ...
        try {
            ...
            processData.setCheckRevisionButtonId(Arrays.asList(
                    ...
                    GXHDO101B033Const.BTN_DELETE_BOTTOM,
    ...
    public ProcessData checkSyorisuu(ProcessData processData){
        ...
        // 処理数ﾁｪｯｸ
        FXHDD01 syorisuuItem = getItemRow(processData.getItemList(), GXHDO101B033Const.SYORISUU);
    ...
    public ProcessData doTempResist(ProcessData processData) {
        ...
        try {
            ...
            if (StringUtil.isEmpty(processData.getInitJotaiFlg()) || JOTAI_FLG_SAKUJO.equals(processData.getInitJotaiFlg())) {
                ...
                // 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録登録処理
                insertTmpSrGdnijibarrel(queryRunnerQcdb, conQcdb, newRev, 0, kojyo, lotNo8, edaban, paramJissekino, systemTime, processData.getItemList(), processData);

            } else {

                // 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録更新処理
                updateTmpSrGdnijibarrel(queryRunnerQcdb, conQcdb, rev, processData.getInitJotaiFlg(), newRev, kojyo, lotNo8, edaban, paramJissekino, systemTime, processData.getItemList(), processData);
    ...
    private ErrorMessageInfo checkItemResistCorrect(ProcessData processData) {
        ...
        // 号機
        FXHDD01 gouki = getItemRow(processData.getItemList(), GXHDO101B033Const.GOUKI);
        ...
        // 処理時間
        FXHDD01 syorijikan = getItemRow(processData.getItemList(), GXHDO101B033Const.SYORIJIKAN);
        if(StringUtil.isEmpty(syorijikan.getValue())){
            //エラー発生時
            errFxhdd01List = Arrays.asList(syorijikan);
            return MessageUtil.getErrorMessageInfo("XHD-000032", true, true, errFxhdd01List, syorijikan.getLabel1());
        }
    ...
    public ProcessData doResist(ProcessData processData) {
        ...
        try {
            ...
            SrGdnijibarrel tmpSrGdnijibarrel = null;
            if (JOTAI_FLG_KARI_TOROKU.equals(processData.getInitJotaiFlg())) {
                
                // 更新前の値を取得
                List<SrGdnijibarrel> srGdnijibarrelList = getSrGdnijibarrelData(queryRunnerQcdb, rev.toPlainString(), processData.getInitJotaiFlg(), kojyo, lotNo8, edaban, paramJissekino);
                if (!srGdnijibarrelList.isEmpty()) {
                    tmpSrGdnijibarrel = srGdnijibarrelList.get(0);
                }
                
                deleteTmpSrGdnijibarrel(queryRunnerQcdb, conQcdb, rev, kojyo, lotNo8, edaban, paramJissekino);
            }

            // 外部電極洗浄(ﾊﾞﾚﾙ)_登録処理
            insertSrGdnijibarrel(queryRunnerQcdb, conQcdb, newRev, kojyo, lotNo8, edaban, paramJissekino, systemTime, processData.getItemList(), tmpSrGdnijibarrel, processData);
    ...
    public ProcessData doKakunin(ProcessData processData) {
        ...
        processData.setUserAuthParam(GXHDO101B033Const.USER_AUTH_UPDATE_PARAM);
    ...
    public ProcessData doCorrect(ProcessData processData) {
        ...
        try {
            ...
            // 外部電極洗浄(ﾊﾞﾚﾙ)_更新処理
            updateSrGdnijibarrel(queryRunnerQcdb, conQcdb, rev, processData.getInitJotaiFlg(), newRev, kojyo, lotNo8, edaban, paramJissekino, systemTime, processData.getItemList(), processData);
    ...
    public ProcessData checkDataDelete(ProcessData processData) {
        ...
        // ユーザ認証用のパラメータをセットする。
        processData.setRquireAuth(true);
        processData.setUserAuthParam(GXHDO101B033Const.USER_AUTH_DELETE_PARAM);
    ...
    public ProcessData doDelete(ProcessData processData) {
        ...
        try {
            ...
            insertDeleteDataTmpSrGdnijibarrel(queryRunnerQcdb, conQcdb, newRev, newDeleteflag, kojyo, lotNo8, edaban, paramJissekino, systemTime);

            // 外部電極洗浄(ﾊﾞﾚﾙ)削除処理
            deleteSrGdnijibarrel(queryRunnerQcdb, conQcdb, rev, kojyo, lotNo8, edaban, paramJissekino);
        ...
        switch (jotaiFlg) {
            case JOTAI_FLG_TOROKUZUMI:
                activeIdList.addAll(Arrays.asList(
                        GXHDO101B033Const.BTN_EDABAN_COPY_BOTTOM,
                        GXHDO101B033Const.BTN_DELETE_BOTTOM,
                        GXHDO101B033Const.BTN_UPDATE_BOTTOM,
                        GXHDO101B033Const.BTN_START_DATETIME_BOTTOM,
                        GXHDO101B033Const.BTN_END_DATETIME_BOTTOM,
    ...
    public String convertButtonIdToMethod(String buttonId) {
        ...
        switch (buttonId) {
            // 仮登録
            case GXHDO101B033Const.BTN_KARI_TOUROKU_TOP:
            case GXHDO101B033Const.BTN_KARI_TOUROKU_BOTTOM:
                method = "checkDataTempResist";
                break;
            // 登録
            case GXHDO101B033Const.BTN_INSERT_TOP:
            case GXHDO101B033Const.BTN_INSERT_BOTTOM:
                method = "checkDataResist";
                break;
            // 枝番コピー
            case GXHDO101B033Const.BTN_EDABAN_COPY_TOP:
            case GXHDO101B033Const.BTN_EDABAN_COPY_BOTTOM:
                method = "confEdabanCopy";
                break;
            // 修正
            case GXHDO101B033Const.BTN_UPDATE_TOP:
            case GXHDO101B033Const.BTN_UPDATE_BOTTOM:
                method = "checkDataCorrect";
                break;
            // 削除
            case GXHDO101B033Const.BTN_DELETE_TOP:
    ...
    private void setViewItemData(ProcessData processData, Map lotKbnMasData, Map ownerMasData, Map shikakariData, String lotNo ,String syorisuu,BigDecimal ryohinjyuryo) {
        ...
        // KCPNO
        this.setItemData(processData, GXHDO101B033Const.KCPNO, StringUtil.nullToBlank(getMapData(shikakariData, "kcpno")));
        // 客先
        this.setItemData(processData, GXHDO101B033Const.KYAKUSAKI, StringUtil.nullToBlank(getMapData(shikakariData, "tokuisaki")));

        // ロット区分
        String lotkubuncode = StringUtil.nullToBlank(getMapData(shikakariData, "lotkubuncode")); //ﾛｯﾄ区分ｺｰﾄﾞ
        if (StringUtil.isEmpty(lotkubuncode)) {
            this.setItemData(processData, GXHDO101B033Const.LOT_KUBUN, "");
        } else {
            String lotKubun = StringUtil.nullToBlank(getMapData(lotKbnMasData, "lotkubun"));
            this.setItemData(processData, GXHDO101B033Const.LOT_KUBUN, lotkubuncode + ":" + lotKubun);
        }

        // オーナー
        String ownercode = StringUtil.nullToBlank(getMapData(shikakariData, "ownercode"));// ｵｰﾅｰｺｰﾄﾞ
        if (StringUtil.isEmpty(lotkubuncode)) {
            this.setItemData(processData, GXHDO101B033Const.OWNER, "");
        } else {
            String owner = StringUtil.nullToBlank(getMapData(ownerMasData, "ownername"));
            this.setItemData(processData, GXHDO101B033Const.OWNER, ownercode + ":" + owner);
        }
        
        //ﾛｯﾄﾌﾟﾚ
        this.setItemData(processData, GXHDO101B033Const.LOTPRE, StringUtil.nullToBlank(getMapData(shikakariData, "lotpre")));
    ...
    private boolean setInputItemData(ProcessData processData, QueryRunner queryRunnerDoc, QueryRunner queryRunnerQcdb,
        ...
        List<SrGdnijibarrel> srGdnijibarrelDataList = new ArrayList<>();
        String rev = "";
        String jotaiFlg = "";
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // 外部電極洗浄(ﾊﾞﾚﾙ)データ取得
            srGdnijibarrelDataList = getSrGdnijibarrelData(queryRunnerQcdb, rev, jotaiFlg, kojyo, lotNo8, edaban, jissekino);
            if (srGdnijibarrelDataList.isEmpty()) {
        ...
        // メイン画面データ設定
        setInputItemDataMainForm(processData, srGdnijibarrelDataList.get(0));
     ...
     *
     * @param processData 処理制御データ
     * @param srGdnijibarrelData 外部電極洗浄(ﾊﾞﾚﾙ)データ
     */
    private void setInputItemDataMainForm(ProcessData processData, SrGdnijibarrel srGdnijibarrel) {

        // 号機
        this.setItemData(processData, GXHDO101B033Const.GOUKI, getSrGdnijibarrelItemData(GXHDO101B033Const.GOUKI, srGdnijibarrel));
        // 処理時間
        this.setItemData(processData, GXHDO101B033Const.SYORIJIKAN, getSrGdnijibarrelItemData(GXHDO101B033Const.SYORIJIKAN, srGdnijibarrel));
        // 回転数
        ...
        // 備考2
        this.setItemData(processData, GXHDO101B033Const.BIKO2, getSrGdnijibarrelItemData(GXHDO101B033Const.BIKO2, srGdnijibarrel));
        // 外観担当者
        this.setItemData(processData, GXHDO101B033Const.GAIKANTANTOU, getSrGdnijibarrelItemData(GXHDO101B033Const.GAIKANTANTOU, srGdnijibarrel));
 
    }

    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)の入力項目の登録データ(仮登録時は仮登録データ)を取得
     *
     ...
     * @param edaban 枝番
     * @param jissekino 実績No
     * @return 外部電極洗浄(ﾊﾞﾚﾙ)処理登録データ
     * @throws SQLException 例外エラー
     */
    private List<SrGdnijibarrel> getSrGdnijibarrelData(QueryRunner queryRunnerQcdb, String rev, String jotaiFlg,
            String kojyo, String lotNo, String edaban, int jissekino) throws SQLException {

        if (JOTAI_FLG_TOROKUZUMI.equals(jotaiFlg)) {
            return loadSrGdnijibarrel(queryRunnerQcdb, kojyo, lotNo, edaban, jissekino, rev);
        } else {
            return loadTmpSrGdnijibarrel(queryRunnerQcdb, kojyo, lotNo, edaban, jissekino, rev);
        }
    }
     ...
     * @throws SQLException 例外エラー
     */
    private List<SrGdnijibarrel> loadSrGdnijibarrel(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
        ...
        String sql = "SELECT "
                ...
                + ",gaikan,revision, '0' AS deleteflag, gaikantantousya "
        ...
        BeanProcessor beanProcessor = new BeanProcessor(mapping);
        RowProcessor rowProcessor = new BasicRowProcessor(beanProcessor);
        ResultSetHandler<List<SrGdnijibarrel>> beanHandler = new BeanListHandler<>(SrGdnijibarrel.class, rowProcessor);
     ...
     * @throws SQLException 例外エラー
     */
    private List<SrGdnijibarrel> loadTmpSrGdnijibarrel(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
            String edaban, int jissekino, String rev) throws SQLException {
        ...
        String sql = "SELECT "
                ...
                + " ,StartKakuninsyacode,enddatetime,EndTantosyacode,biko1,biko2,biko3,torokunichiji,kosinnichiji,juryou,kansougouki"
                + ",kansoukaishinichiji,kansoutantousya,kansoukaishikakuninsya,kansousyuuryounichiji,kansousyuuryoutantosya,furuisenbetu"
                + ",gaikan,revision,deleteflag,gaikantantousya "
    ...
    public ProcessData edabanCopy(ProcessData processData) {
        try {
            ...
            // 外部電極洗浄(ﾊﾞﾚﾙ)データ取得
            List<SrGdnijibarrel> srGdnijibarrelDataList = getSrGdnijibarrelData(queryRunnerQcdb, "", jotaiFlg, kojyo, lotNo8, oyalotEdaban, paramJissekino);
            if (srGdnijibarrelDataList.isEmpty()) {
                processData.setErrorMessageInfoList(Arrays.asList(new ErrorMessageInfo(MessageUtil.getMessage("XHD-000030"))));
                return processData;
            }
     ...
     * @return 入力値
     */
    private String getItemData(List<FXHDD01> listData, String itemId, SrGdnijibarrel srGdnijibarrelData) {
        List<FXHDD01> selectData
                = listData.stream().filter(n -> itemId.equals(n.getItemId())).collect(Collectors.toList());
        if (null != selectData && 0 < selectData.size()) {
            return selectData.get(0).getValue();
        } else if (srGdnijibarrelData != null) {
            // 元データが存在する場合元データより取得
            return getSrGdnijibarrelItemData(itemId, srGdnijibarrelData);
        } else {
            return null;
        }
    }
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録(tmp_sr_gdnijibarrel)登録処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     ...
     * @throws SQLException 例外エラー
     */
    private void insertTmpSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev, int deleteflag,
        ...
        String sql = "INSERT INTO tmp_sr_gdnijibarrel ("
                ...
                + ",kansousyuuryounichiji,kansousyuuryoutantosya,furuisenbetu,gaikan,biko1,biko2,biko3,torokunichiji,kosinnichiji,revision, deleteflag,gaikantantousya "
                + ") VALUES ("
                + " ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録(tmp_sr_gdnijibarrel)更新処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param rev revision
     ...
     * @throws SQLException 例外エラー
     */
    private void updateTmpSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev, String jotaiFlg, BigDecimal newRev,
            String kojyo, String lotNo, String edaban, int jissekino, Timestamp systemTime, List<FXHDD01> itemList, ProcessData processData) throws SQLException {
        ...
        String sql = "UPDATE tmp_sr_gdnijibarrel SET "
                ...
                + " biko2 = ?, kosinnichiji = ?, revision = ?, deleteflag = ?, gaikantantousya = ? "
                + "WHERE kojyo = ? AND lotno = ? AND edaban = ? AND kaisuu = ? AND revision = ? ";

        // 更新前の値を取得
        List<SrGdnijibarrel> srGdnijibarrelList = getSrGdnijibarrelData(queryRunnerQcdb, rev.toPlainString(), jotaiFlg, kojyo, lotNo, edaban, jissekino);
        SrGdnijibarrel srGdnijibarrel = null;
        if (!srGdnijibarrelList.isEmpty()) {
            srGdnijibarrel = srGdnijibarrelList.get(0);
        }

        //更新値設定
        List<Object> params = setUpdateParameterTmpSrGdnijibarrel(false, newRev, 0, "", "", "", systemTime, itemList, srGdnijibarrel, jissekino, processData);
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録(tmp_sr_gdnijibarrel)削除処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param rev revision
     ...
     * @throws SQLException 例外エラー
     */
    private void deleteTmpSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev,
            String kojyo, String lotNo, String edaban, int jissekino) throws SQLException {

        String sql = "DELETE FROM tmp_sr_gdnijibarrel "
                + "WHERE kojyo = ? AND lotno = ? AND edaban = ? AND kaisuu = ? AND revision = ?";
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録(tmp_sr_gdnijibarrel)更新値パラメータ設定
     *
     ...
     * @return 更新パラメータ
     */
    private List<Object> setUpdateParameterTmpSrGdnijibarrel(boolean isInsert, BigDecimal newRev, int deleteflag, String kojyo,
            String lotNo, String edaban, Timestamp systemTime, List<FXHDD01> itemList, SrGdnijibarrel srGdnijibarrelData, int jissekino, ProcessData processData) {
        List<Object> params = new ArrayList<>();
        if (isInsert) {
            params.add(kojyo); //工場ｺｰﾄﾞ
            params.add(lotNo); //ﾛｯﾄNo
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B033Const.KCPNO, srGdnijibarrelData))); //KCPNO
         
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B033Const.KYAKUSAKI, srGdnijibarrelData))); //客先 
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B033Const.SYORIJIKAN, srGdnijibarrelData))); // 処理時間
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B033Const.BIKO2, srGdnijibarrelData))); // 備考2
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(itemList, GXHDO101B033Const.GAIKANTANTOU, srGdnijibarrelData))); // 外観担当者
        
        return params;
    }

    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)(sr_gdnijibarrel)登録処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param newRev 新Revision
     ...
     * @param systemTime システム日付(品質DB登録実績に更新した値と同値)
     * @param itemList 項目リスト
     * @param tmpSrGdnijibarrel 仮登録データ
     * @param processData 処理制御データ
     * @throws SQLException 例外エラー
     */
    private void insertSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev,
        ...
        String sql = "INSERT INTO sr_gdnijibarrel ("
                ...
                + " ,potsuu,methanolkoukanjikan,methanolkoukantantousya,methanolkoukanpotruikeisuu,startdatetime,StartTantosyacode "
                + " ,StartKakuninsyacode,enddatetime,EndTantosyacode,kansougouki,kansoukaishinichiji,kansoutantousya,kansoukaishikakuninsya"
                + ",kansousyuuryounichiji,kansousyuuryoutantosya,furuisenbetu,gaikan,biko1,biko2,biko3,torokunichiji,kosinnichiji,revision,gaikantantousya "
                + ") VALUES ("
                + " ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)(sr_gdnijibarrel)更新処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param rev revision
    ...
    private void updateSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev, String jotaiFlg, BigDecimal newRev,
        ...
        String sql = "UPDATE sr_gdnijibarrel SET "
                ...
                + "StartKakuninsyacode = ?, enddatetime = ?, EndTantosyacode = ?,kansougouki = ?,kansoukaishinichiji = ?,kansoutantousya = ?,"
                + "kansoukaishikakuninsya = ?,kansousyuuryounichiji = ?,kansousyuuryoutantosya = ?,furuisenbetu = ?,gaikan = ?, biko1 = ?, "
                + " biko2 = ?, kosinnichiji = ?, revision = ?, gaikantantousya = ? "
                + "WHERE kojyo = ? AND lotno = ? AND edaban = ? AND kaisuu = ? AND revision = ? ";
        ...
        //更新値設定
        List<Object> params = setUpdateParameterSrGdnijibarrel(false, newRev, "", "", "", jissekino, systemTime, itemList, srGdnijibarrel, processData);
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)(sr_gdnijibarrel)更新値パラメータ設定
     *
     * @param isInsert 登録判定(true:insert、false:update)
     * @param newRev 新revision
     * @param kojyo 工場ｺｰﾄﾞ
     ...
     * @return 更新パラメータ
     */
    private List<Object> setUpdateParameterSrGdnijibarrel(boolean isInsert, BigDecimal newRev, String kojyo, String lotNo, String edaban,
            int jissekino, Timestamp systemTime, List<FXHDD01> itemList, SrGdnijibarrel srGdnijibarrelData, ProcessData processData ) {
        List<Object> params = new ArrayList<>();
        ...
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.KCPNO, srGdnijibarrelData))); //KCPNO
         
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.KYAKUSAKI, srGdnijibarrelData))); //客先 
        ...
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.SYORIJIKAN, srGdnijibarrelData))); // 処理時間

        params.add(DBUtil.stringToBigDecimalObject(getItemData(itemList, GXHDO101B033Const.KAITENSUU, srGdnijibarrelData))); // 回転数
        ...
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.KAISHI_TANTOUSYA, srGdnijibarrelData))); // 開始担当者
        
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.KAISHI_KAKUNINSYA, srGdnijibarrelData))); // 開始確認者
        
        params.add(DBUtil.stringToDateObject(getItemData(itemList, GXHDO101B033Const.SHURYOU_DAY, srGdnijibarrelData),
        ...
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.BIKO2, srGdnijibarrelData))); // 備考2
        ...
        params.add(newRev); //revision
        params.add(DBUtil.stringToStringObject(getItemData(itemList, GXHDO101B033Const.GAIKANTANTOU, srGdnijibarrelData))); // 外観担当者

        return params;
    }

    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)(sr_gdnijibarrel)削除処理
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param rev revision
     ...
     * @throws SQLException 例外エラー
     */
    private void deleteSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev,
            String kojyo, String lotNo, String edaban, int jissekino) throws SQLException {

        String sql = "DELETE FROM sr_gdnijibarrel "
                + "WHERE kojyo = ? AND lotno = ? AND edaban = ? AND kaisuu = ? AND revision = ?";
    ...
    /**
     * [外部電極洗浄(ﾊﾞﾚﾙ)_仮登録]から最大値+1の削除ﾌﾗｸﾞを取得する
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param kojyo 工場ｺｰﾄﾞ
     * @param lotNo ﾛｯﾄNo
    ...
    public ProcessData setKaishiDateTime(ProcessData processDate) {
        FXHDD01 itemDay = getItemRow(processDate.getItemList(), GXHDO101B033Const.KAISHI_DAY);
        FXHDD01 itemTime = getItemRow(processDate.getItemList(), GXHDO101B033Const.KAISHI_TIME);
     ...
     * @return DB値
     */
    private String getSrGdnijibarrelItemData(String itemId, SrGdnijibarrel srGdnijibarrelData) {
        switch (itemId) {
            // KCPNO
            case GXHDO101B033Const.KCPNO:
                return StringUtil.nullToBlank(srGdnijibarrelData.getKcpno());
            // 客先
            case GXHDO101B033Const.KYAKUSAKI:
                return StringUtil.nullToBlank(srGdnijibarrelData.getTokuisaki());
            // ﾛｯﾄ区分
            case GXHDO101B033Const.LOT_KUBUN:
                return StringUtil.nullToBlank(srGdnijibarrelData.getLotkubuncode());
            // ｵｰﾅｰ
            case GXHDO101B033Const.OWNER:
                return StringUtil.nullToBlank(srGdnijibarrelData.getOwnercode());
            // ﾛｯﾄﾌﾟﾚ
            case GXHDO101B033Const.LOTPRE:
                return StringUtil.nullToBlank(srGdnijibarrelData.getLotpre());
            // 処理数
            case GXHDO101B033Const.SYORISUU:
                return StringUtil.nullToBlank(srGdnijibarrelData.getSyorisuu());
            // 号機
            case GXHDO101B033Const.GOUKI:
                return StringUtil.nullToBlank(srGdnijibarrelData.getGouki());
            // 処理時間
            case GXHDO101B033Const.SYORIJIKAN:
                return StringUtil.nullToBlank(srGdnijibarrelData.getSyorijikan());                
            // 回転数
            case GXHDO101B033Const.KAITENSUU:
            ...
            // 備考2
            case GXHDO101B033Const.BIKO2:
                return StringUtil.nullToBlank(srGdnijibarrelData.getBiko2());
            // 外観担当者
            case GXHDO101B033Const.GAIKANTANTOU:
                return StringUtil.nullToBlank(srGdnijibarrelData.getGaikantantousya());
            default:
                return null;            
        }
    }
    ...
    /**
     * 外部電極洗浄(ﾊﾞﾚﾙ)_仮登録(tmp_sr_gdnijibarrel)登録処理(削除時)
     *
     * @param queryRunnerQcdb QueryRunnerオブジェクト
     * @param conQcdb コネクション
     * @param newRev 新Revision
     ...
     * @throws SQLException 例外エラー
     */
    private void insertDeleteDataTmpSrGdnijibarrel(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev, int deleteflag,
