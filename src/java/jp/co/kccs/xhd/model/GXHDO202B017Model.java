 ...
 */
/**
 * ﾊﾞｲﾝﾀﾞｰ溶液作製・撹拌履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/11/22
 */
public class GXHDO202B017Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** 粉末投入_開始日時 */
    private Timestamp funmatutounyuu_kaisinichiji = null;

    /** 粉末投入_終了日時 */
    private Timestamp funmatutounyuu_syuuryounichiji = null;

    /** 羽根の種類 */
    private String hanenosyurui = "";

    /** 撹拌_開始日時 */
    private Timestamp kakuhan_kaisinichiji = null;

    /** 撹拌_終了日時 */
    private Timestamp kakuhan_syuuryounichiji = null;
    ...
    /** ｴｰｼﾞﾝｸﾞ_開始日時 */
    private Timestamp aging_kaisinichiji = null;

    /** ｴｰｼﾞﾝｸﾞ_終了日時 */
    private Timestamp aging_syuuryounichiji = null;
