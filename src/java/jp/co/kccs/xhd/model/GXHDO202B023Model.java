 ...
 */
/**
 * 誘電体ｽﾗﾘｰ作製・ﾌﾟﾚﾐｷｼﾝｸﾞ履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/11/23
 */
public class GXHDO202B023Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** 自動運転 */
    private String jidouunten = "";

    /** ﾀﾝｸAB循環 */
    private String tankABjyunkan = "";
    ...
    /** ｱｰｽｸﾞﾘｯﾌﾟ接続確認 */
    private String earthgripsetuzokukakunin = "";
    ...
    /** 撹拌開始日時① */
    private Timestamp kakuhankaisinichiji1 = null;

    /** 撹拌終了日時① */
    private Timestamp kakuhansyuuryounichiji1 = null;
    ...
    /** 撹拌開始日時③ */
    private Timestamp kakuhankaisinichiji3 = null;

    /** 撹拌終了日時③ */
    private Timestamp kakuhansyuuryounichiji3 = null;
    ...
    /** 撹拌開始日時④ */
    private Timestamp kakuhankaisinichiji4 = null;

    /** 撹拌終了日時④ */
    private Timestamp kakuhansyuuryounichiji4 = null;
    ...
    /** 撹拌開始日時⑤ */
    private Timestamp kakuhankaisinichiji5 = null;

    /** 撹拌終了日時⑤ */
    private Timestamp kakuhansyuuryounichiji5 = null;
    ...
    /** 撹拌開始日時⑥ */
    private Timestamp kakuhankaisinichiji6 = null;

    /** 撹拌終了日時⑥ */
    private Timestamp kakuhansyuuryounichiji6 = null;
    ...
    /** 撹拌開始日時⑦ */
    private Timestamp kakuhankaisinichiji7 = null;

    /** 回転体への接触の確認 */
    private String kaitentaihenosessyokunokakunin = "";

    /** 撹拌終了日時⑦ */
    private Timestamp kakuhansyuuryounichiji7 = null;
     ...
     */
    public String getYouzaitounyuu() {
     ...
     */
    public void setYouzaitounyuu(String youzaitounyuu) {
     ...
     */
    public void setJidouunten(String jidouunten) {
     ...
     */
    public String getTankABjyunkan() {
     ...
     */
    public void setTankABjyunkan(String tankABjyunkan) {
     ...
     */
    public String getEarthgripsetuzokukakunin() {
     ...
     */
    public void setEarthgripsetuzokukakunin(String earthgripsetuzokukakunin) {
     ...
     */
    public String getKaitentaihenosessyokunokakunin() {
     ...
     */
    public void setKaitentaihenosessyokunokakunin(String kaitentaihenosessyokunokakunin) {
