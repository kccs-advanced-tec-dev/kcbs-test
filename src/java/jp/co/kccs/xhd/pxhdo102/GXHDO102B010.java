...
public class GXHDO102B010 implements IFormLogic {
    ...
    private ErrorMessageInfo checkInputKikakuchi(ProcessData processData, List<KikakuchiInputErrorInfo> kikakuchiInputErrorInfoList) {
        ...
        // エラー項目の背景色を設定
        setItemBackColor(processData, totyukakuhankaisiList, totyukakuhansyuryoList, totyukakuhanjikan, kikakuchiInputErrorInfoList, errorMessageInfo);
        setItemBackColor(processData, kakuhankaisiList, kakuhansyuryo1List, kakuhanjikan, kikakuchiInputErrorInfoList, errorMessageInfo);
    ...
    private ErrorMessageInfo checkItemRegistCorrect(ProcessData processData) {
        ...
        // 担当者、確認者チェック
        FXHDD01 itemTantousya = getItemRow(processData.getItemList(), GXHDO102B010Const.TANTOUSYA); // 担当者
        FXHDD01 itemKakuninsya = getItemRow(processData.getItemList(), GXHDO102B010Const.KAKUNINSYA); // 確認者
    ...
    private void setViewItemData(ProcessData processData, Map shikakariData, String lotNo) {
        ...
        this.setItemData(processData, GXHDO102B010Const.TENKAZAISLURRYHINMEI, hinmei);
        // 添加材ｽﾗﾘｰLotNo
