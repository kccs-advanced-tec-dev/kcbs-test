...
public class GXHDO102C003 implements Serializable {
    ...
    private boolean checkOK() {
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c003ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
        if(!checkTyogouryouKikaku(subDataBuzaitabList, subDataTyogouryoukikaku)){
            return false;
        }
        return true;
    }
