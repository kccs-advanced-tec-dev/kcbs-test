 ...
 */
/**
 * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/11/22
 */
public class GXHDO202B016Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** ﾊﾞｲﾝﾀﾞｰ樹脂①_調合量1 */
    private Integer binderjyusi1_tyougouryou1 = null;

    /** ﾊﾞｲﾝﾀﾞｰ樹脂①_部材在庫No2 */
    private String binderjyusi1_buzaizaikono2 = "";

    /** ﾊﾞｲﾝﾀﾞｰ樹脂①_調合量2 */
    private Integer binderjyusi1_tyougouryou2 = null;
    ...
    /** ﾊﾞｲﾝﾀﾞｰ樹脂②_調合量1 */
    private Integer binderjyusi2_tyougouryou1 = null;

    /** ﾊﾞｲﾝﾀﾞｰ樹脂②_部材在庫No2 */
    private String binderjyusi2_buzaizaikono2 = "";

    /** ﾊﾞｲﾝﾀﾞｰ樹脂②_調合量2 */
    private Integer binderjyusi2_tyougouryou2 = null;
