 ...
 */
/**
 * GXHDO102C008(ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力)
 *
 * @author KCSS wxf
 * @since 2021/11/02
 */
@ManagedBean(name = "beanGXHDO102C008")
@SessionScoped
public class GXHDO102C008 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C008.class.getName());
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ
     */
    private GXHDO102C008Model gxhdO102c008Model;

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C008Model gxhdO102c008ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C008Logic.setSubgamenDataFromView(this.getGxhdO102c008ModelView(), this.getGxhdO102c008Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C008Model.SubGamenData showsubgamendata = this.getGxhdO102c008ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C008Logic.clearBackColor(this.getGxhdO102c008ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c008ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C008Logic.calcTyogouzanryou(this.getGxhdO102c008ModelView());
        GXHDO102C008Logic.setShowsubgamendataFromView(this.getGxhdO102c008ModelView(), this.getGxhdO102c008Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c008ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c008ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C008Model gxhdo102c008model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面
     * @param errorId エラーID
     ...
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ
     *
     * @return the gxhdO102c008Model
     */
    public GXHDO102C008Model getGxhdO102c008Model() {
     ...
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ
     *
     * @param gxhdO102c008Model the gxhdO102c008Model to set
     */
    public void setGxhdO102c008Model(GXHDO102C008Model gxhdO102c008Model) {
        this.gxhdO102c008Model = gxhdO102c008Model;
    }

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c008ModelView
     */
    public GXHDO102C008Model getGxhdO102c008ModelView() {
        return gxhdO102c008ModelView;
    }

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c008ModelView the gxhdO102c008ModelView to set
     */
    public void setGxhdO102c008ModelView(GXHDO102C008Model gxhdO102c008ModelView) {
        this.gxhdO102c008ModelView = gxhdO102c008ModelView;
    }
}
