...
import jp.co.kccs.xhd.model.GXHDO201B013Model;
...
@Named
@ViewScoped
public class GXHDO201B013 implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(GXHDO201B013.class.getName());
    ...
    /** 一覧表示データ */
    private List<GXHDO201B013Model> listData = null;
...
//<editor-fold defaultstate="collapsed" desc="#getter setter">
     ...
     * @return 一覧表示データ
     */
    public List<GXHDO201B013Model> getListData() {
        return listData;
    }
...
//</editor-fold>
    ...
    public void init() {
        ...
        if (!StringUtil.isEmpty(selectParam.getValue("GXHDO201B013_display_page_count", session))) {
            listDisplayPageCount = Integer.parseInt(selectParam.getValue("GXHDO201B013_display_page_count", session));
        }
        ...
        if (!StringUtil.isEmpty(sayadumeGouki)) {
            ...
            if (!existGoukiMaster) {
                FacesMessage message = 
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, MessageUtil.getMessage("XHD-000011", "ｾｯﾀ詰め号機"), null);
                FacesContext.getCurrentInstance().addMessage(null, message);
                return;
            }
        }        
    ...
    public void selectListData() {
        try {
            ...
            String sql = "SELECT CONCAT(IFNULL(KOJYO, ''), IFNULL(LOTNO, ''), IFNULL(EDABAN, '')) AS LOTNO "
                    ...
                    + ", settertumeryou "
                    + ", settertumehouhou "
                    + ", (CASE WHEN settersyurui = 0 THEN '未使用' WHEN settersyurui = 1 THEN '使用' ELSE NULL END) AS settersyurui "
            ...
            mapping.put("sayadumegouki", "sayadumegouki");             // ｾｯﾀ詰め号機
            mapping.put("sayasuu", "sayasuu");                         // ｾｯﾀ枚数(枚)
            mapping.put("kosuu", "kosuu");                             // 処理数(個)
            ...
            mapping.put("settertumeryou", "settertumeryou");           // ｾｯﾀ詰め量(個)
            ...
            ResultSetHandler<List<GXHDO201B013Model>> beanHandler = 
                    new BeanListHandler<>(GXHDO201B013Model.class, rowProcessor);
    ...
    public void downloadExcel() throws Throwable {
        ...
        try {
            ...
            // Excel出力定義を取得
            File file = new File(servletContext.getRealPath("/WEB-INF/classes/resources/json/gxhdo201b013.json")); 
    ...
    private List<Object> createSearchParam() {
        ...
        String paramSayadumeGouki = StringUtil.blankToNull(getSayadumeGouki());
        ...
        params.addAll(Arrays.asList(paramSayadumeGouki, paramSayadumeGouki));
