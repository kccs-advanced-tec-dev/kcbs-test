...
public class GXHDO101B041 implements IFormLogic {
    ...
    public ProcessData initial(ProcessData processData) {
        try {
            ...
            processData.setNoCheckButtonId(Arrays.asList(
                    ...
                    GXHDO101B041Const.BTN_BUZAI_ZAIKO_ZYOUHOU_TOP,
                    GXHDO101B041Const.BTN_SENBETSU_STARTDATETIME_BOTTOM,
                    GXHDO101B041Const.BTN_SENBETSU_ENDDATETIME_BOTTOM,
                    GXHDO101B041Const.BTN_BIN_KEISAN_BOTTOM,
                    GXHDO101B041Const.BTN_RYOHIN_KEISAN_BOTTOM,
                    GXHDO101B041Const.BTN_BUDOMARI_KEISAN_BOTTOM,
                    GXHDO101B041Const.BTN_NETSUSYORI_KEISAN_BOTTOM,
                    GXHDO101B041Const.BTN_HOSEIRITSU_KEISAN_BOTTOM,
                    GXHDO101B041Const.BTN_SETSUBI_DATA_TORIKOMI_BOTTOM,
                    GXHDO101B041Const.BTN_BUZAI_ZAIKO_ZYOUHOU_BOTTOM
            ));
            ...
            processData.setCheckRevisionButtonId(Arrays.asList(
                    ...
                    GXHDO101B041Const.BTN_KARI_TOUROKU_BOTTOM,
                    GXHDO101B041Const.BTN_INSERT_BOTTOM,
                    GXHDO101B041Const.BTN_DELETE_BOTTOM,
                    GXHDO101B041Const.BTN_UPDATE_BOTTOM
            ));
     ...
     * @return 処理制御データ
     */
    public ProcessData doBuzaiZaikoZyouhou(ProcessData processData) {
        processData.setMethod("");
        //部材在庫情報
        doBuzaiZaiko(processData);
        return processData;
    }
    ...
    private Map<String, Object> getShiteiKousabudomari(ProcessData processData, QueryRunner queryRunnerWip, String lotNo, List<String> errorMessageList) {
        ...
        FXHDD01 siteikousaBudomari3 = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_SHITEI_KOUSA_BUDOMARI3);
        // QA履歴データ取得
    ...
    private void setViewItemData(ProcessData processData, Map sekkeiData, Map lotKbnMasData, Map ownerMasData, Map shikakariData, Map siteiKousaBudomariInfo, String lotNo, String kosa1, String kosa2, String kosa3) {
        ...
        if (siteiKousaBudomariInfo != null) {
            ...
            kousaBudomari3.append(" %");
            this.setItemData(processData, GXHDO101B041Const.SEIHIN_SHITEI_KOUSA_BUDOMARI3, kousaBudomari3.toString());
        }
        
        // 第1公差
        this.setItemData(processData, GXHDO101B041Const.KOSA1, StringUtil.nullToBlank(kosa1));

        // 第2公差
        this.setItemData(processData, GXHDO101B041Const.KOSA2, StringUtil.nullToBlank(kosa2));

        // 第3公差
        this.setItemData(processData, GXHDO101B041Const.KOSA3, StringUtil.nullToBlank(kosa3));
    ...
    private boolean setInputItemData(ProcessData processData, QueryRunner queryRunnerDoc, QueryRunner queryRunnerQcdb,
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (StringUtil.isEmpty(rev) || !(JOTAI_FLG_KARI_TOROKU.equals(jotaiFlg) || JOTAI_FLG_TOROKUZUMI.equals(jotaiFlg))) {
                ...
                //受入総重量計算処理
                FXHDD01 itemUkeireSojuryo = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_SOUJURYO);
                FXHDD01 itemOkuriRyohinsu = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_OKURI_RYOHINSU);
                FXHDD01 itemUkeireTanijuryo = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_TANNIJURYO);
                ...
                if (srShinkuukansou != null && !srShinkuukansou.isEmpty()) {
                    ...
                    setItemData(processData, GXHDO101B041Const.SEIHIN_NETSUSYORI_TIME, DateUtil.formattedTimestamp((Timestamp) srShinkuukansou.get("syuryonichiji"), "HHmm"));
                }
    ...
    private void setInputItemDataFormA(ProcessData processData, SrDenkitokuseiesi srDenkitokuseiesi) {
        ...
        // 製品情報:最大処理数
        this.setItemData(processData, GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU, srDenkitokuseiesi));
        
        // 製品情報:累計処理数
        this.setItemData(processData, GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU, srDenkitokuseiesi));
        ...
        // 製品情報:同品種
        this.setItemData(processData, GXHDO101B041Const.SEIHIN_DOUHINSYU, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SEIHIN_DOUHINSYU, srDenkitokuseiesi));
    ...
    private void setInputItemDataFormB(ProcessData processData, SrDenkitokuseiesi srDenkitokuseiesi) {
        ...
        // 耐電圧設定条件:IR① 判定値(低)
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, srDenkitokuseiesi));

        // 耐電圧設定条件:IR① 判定値 単位
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, srDenkitokuseiesi));
        ...
        // 耐電圧設定条件:IR② 判定値(低)
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, srDenkitokuseiesi));

        // 耐電圧設定条件:IR② 判定値 単位
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, srDenkitokuseiesi));
        ...
        // 耐電圧設定条件:IR① 判定値(低) 単位
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, srDenkitokuseiesi));

        // 耐電圧設定条件:IR② 判定値(低) 単位
        this.setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, getSrDenkitokuseiesiItemData(GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, srDenkitokuseiesi));
    ...
    private void setInputItemDataFormD(ProcessData processData, SrDenkitokuseiesi srDenkitokuseiesi) {
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN1_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN1_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN1 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN1_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN1_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN1_FUKURO_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN1_FUKURO_CHECK, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN2_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN2_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN2 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN2_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN2_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN2_FUKURO_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN2_FUKURO_CHECK, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN3_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN3_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN3 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN3_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN3_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN3_FUKURO_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN3_FUKURO_CHECK, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN4_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN4_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN4 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN4_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN4_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN4_FUKURO_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN4_FUKURO_CHECK, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN5_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN5_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN5 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN5_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN5_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN6_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN6_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN6 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN6_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN6_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN7 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN7 抜き取り結果
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN7 真の不良率(%)
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN7 結果ﾁｪｯｸ
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_COUNTER_SU2, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_COUNTER_SU2, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN8 ｶｳﾝﾀｰ数3
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_COUNTER_SU3, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_COUNTER_SU3, srDenkitokuseiesi));
        ...
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN8 抜き取り結果
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN8 真の不良率(%)
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, srDenkitokuseiesi));

        // 設定条件及び処理結果:BIN8 結果ﾁｪｯｸ
        this.setItemDataEx(processData, GXHDO101B041Const.SET_BIN8_KEKKA_CHECK, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_BIN8_KEKKA_CHECK, srDenkitokuseiesi));
        ...
        // 設定条件及び処理結果:SATｻﾝﾌﾟﾙ
        this.setItemDataEx(processData, GXHDO101B041Const.SET_SAT_SAMPLE, getSrDenkitokuseiesiItemData(GXHDO101B041Const.SET_SAT_SAMPLE, srDenkitokuseiesi));
    ...
    private List<SrDenkitokuseiesi> loadSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
        ...
        String sql = "SELECT "
                ...
                + "irhanteiti1low,irhanteiti1tani,irhanteiti2low,irhanteiti2tani,bin1countersuu2,bin1countersuu3,bin2countersuu2,bin2countersuu3,bin3countersuu2,bin3countersuu3,bin4countersuu2,bin4countersuu3,"
                + "bin5countersuu2,bin5countersuu3,bin6countersuu2,bin6countersuu3,bin7countersuu2,bin7countersuu3,bin8countersuu2,bin8countersuu3,douhinsyu,irhanteiti1tanilow,irhanteiti2tanilow, "
                + "saidaisyorisuu,ruikeisyorisuu "
        ...
        mapping.put("irhanteiti2tanilow", "irhanteiti2tanilow"); //同品種
    ...
    private List<SrDenkitokuseiesi> loadTmpSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, String kojyo, String lotNo,
        ...
        String sql = "SELECT "
                + "kojyo,lotno,edaban,kaisuu,kcpno,tokuisaki,ownercode,lotkubuncode,siteikousa,atokouteisijinaiyou,saidaisyorisuu,ruikeisyorisuu,okuriryouhinsuu,ukeiretannijyuryo,ukeiresoujyuryou,"
                + "gdyakitukenitiji,mekkinitiji,kensabasyo,senbetukaisinitiji,senbetusyuryounitiji,kensagouki,bunruiairatu,cdcontactatu,ircontactatu,stationcd1,stationpc1,stationpc2,"
                + "stationpc3,stationpc4,stationir1,stationir2,stationir3,stationir4,stationir5,stationir6,stationir7,stationir8,koteidenkyoku,torakkugaido,testplatekeijo,bunruifukidasi,"
                + "testplatekakunin,denkyokuseisou,senbetujunjo,setteikakunin,haisenkakunin,seihintounyuujotai,binboxseisoucheck,setsya,kakuninsya,siteikousabudomari1,siteikousabudomari2,siteikousabudomari3,"
                + "testplatekanrino,tan,sokuteisyuhasuu,sokuteidenatu,hoseiyoutippuyoryou,hoseiyoutipputan,hoseimae,hoseigo,hoseiritu,Standard,bunruikakunin,gaikankakunin,netsusyorinitiji,"
    ...
    private void updateTmpSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev, String jotaiFlg, BigDecimal newRev,
        ...
        String sql = "UPDATE tmp_sr_denkitokuseiesi SET "
                + "kcpno = ?,tokuisaki = ?,ownercode = ?,lotkubuncode = ?,siteikousa = ?,atokouteisijinaiyou = ?,saidaisyorisuu = ?,ruikeisyorisuu = ?,okuriryouhinsuu = ?,ukeiretannijyuryo = ?,ukeiresoujyuryou = ?,gdyakitukenitiji = ?,"
                ...
                + "revision = ?,deleteflag = ?,irhanteiti1low = ?,irhanteiti1tani = ?,irhanteiti2low = ?,irhanteiti2tani = ?,"
                + "bin1countersuu2 = ?,bin1countersuu3 = ?,bin2countersuu2 = ?,bin2countersuu3 = ?,bin3countersuu2 = ?,bin3countersuu3 = ?,bin4countersuu2 = ?,bin4countersuu3 = ?,"
                + "bin5countersuu2 = ?,bin5countersuu3 = ?,bin6countersuu2 = ?,bin6countersuu3 = ?,bin7countersuu2 = ?,bin7countersuu3 = ?,bin8countersuu2 = ?,bin8countersuu3 = ?,douhinsyu = ?,irhanteiti1tanilow = ?, irhanteiti2tanilow = ? "
    ...
    private List<Object> setUpdateParameterTmpSrDenkitokuseiesi(boolean isInsert, BigDecimal newRev, int deleteflag, String kojyo,
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemList, GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU, srDenkitokuseiesi))); //最大処理数
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemList, GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU, srDenkitokuseiesi))); //累計処理数
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemList, GXHDO101B041Const.SEIHIN_SHITEI_KOUSA_BUDOMARI3, srDenkitokuseiesi))); //指定公差歩留まり3
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_FUKURO_CHECK, srDenkitokuseiesi))); //BIN1 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_FUKURO_CHECK, srDenkitokuseiesi))); //BIN2 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_FUKURO_CHECK, srDenkitokuseiesi))); //BIN3 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_FUKURO_CHECK, srDenkitokuseiesi))); //BIN4 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, srDenkitokuseiesi))); //BIN7 抜き取り結果
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T, srDenkitokuseiesi))); //BIN7 抜き取り結果
        params.add(DBUtil.stringToBigDecimalObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, srDenkitokuseiesi))); //BIN7 真の不良率(%)
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, srDenkitokuseiesi))); //BIN7 結果ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, srDenkitokuseiesi))); //BIN8 抜き取り結果
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T, srDenkitokuseiesi))); //BIN8 抜き取り結果
        params.add(DBUtil.stringToBigDecimalObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, srDenkitokuseiesi))); //BIN8 真の不良率(%)
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_KEKKA_CHECK, srDenkitokuseiesi))); //BIN8 結果ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_SAT_SAMPLE, srDenkitokuseiesi))); //SATｻﾝﾌﾟﾙ
        ...
        params.add(DBUtil.stringToBigDecimalObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値(低)
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
        params.add(DBUtil.stringToBigDecimalObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR② 判定値(低)
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, srDenkitokuseiesi))); //耐電圧設定条件 IR② 判定値 単位
        if (isInsert) {
        ...
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_COUNTER_SU2, srDenkitokuseiesi))); //BIN1 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_COUNTER_SU3, srDenkitokuseiesi))); //BIN1 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_COUNTER_SU2, srDenkitokuseiesi))); //BIN2 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_COUNTER_SU3, srDenkitokuseiesi))); //BIN2 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_COUNTER_SU2, srDenkitokuseiesi))); //BIN3 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_COUNTER_SU3, srDenkitokuseiesi))); //BIN3 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_COUNTER_SU2, srDenkitokuseiesi))); //BIN4 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_COUNTER_SU3, srDenkitokuseiesi))); //BIN4 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN5_COUNTER_SU2, srDenkitokuseiesi))); //BIN5 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN5_COUNTER_SU3, srDenkitokuseiesi))); //BIN5 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN6_COUNTER_SU2, srDenkitokuseiesi))); //BIN6 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN6_COUNTER_SU3, srDenkitokuseiesi))); //BIN6 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_COUNTER_SU2, srDenkitokuseiesi))); //BIN7 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_COUNTER_SU3, srDenkitokuseiesi))); //BIN7 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_COUNTER_SU2, srDenkitokuseiesi))); //BIN8 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_COUNTER_SU3, srDenkitokuseiesi))); //BIN8 ｶｳﾝﾀｰ数3
        params.add(getCheckBoxDbValue(getItemData(pItemList, GXHDO101B041Const.SEIHIN_DOUHINSYU, srDenkitokuseiesi), null)); //同品種
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
        params.add(DBUtil.stringToStringObjectDefaultNull(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
    ...
    private void insertSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev,
        ...
        String sql = "INSERT INTO sr_denkitokuseiesi ("
                ...
                + "irhanteiti5low,irhanteiti5tani,irhanteiti6low,irhanteiti6tani,irhanteiti7low,irhanteiti7tani,irhanteiti8low,irhanteiti8tani,"
                + "bin1countersuu2,bin1countersuu3,bin2countersuu2,bin2countersuu3,bin3countersuu2,bin3countersuu3,bin4countersuu2,bin4countersuu3,"
                + "bin5countersuu2,bin5countersuu3,bin6countersuu2,bin6countersuu3,bin7countersuu2,bin7countersuu3,bin8countersuu2,bin8countersuu3,douhinsyu,irhanteiti1tanilow,irhanteiti2tanilow,irhanteiti3tanilow,irhanteiti4tanilow,irhanteiti5tanilow,irhanteiti6tanilow,irhanteiti7tanilow,irhanteiti8tanilow"
                + ") VALUES ("
                + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
                + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
                + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
    ...
    private void updateSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal rev, String jotaiFlg, BigDecimal newRev,
        ...
        String sql = "UPDATE sr_denkitokuseiesi SET "
                ...
                + "handasample = ?,sinraiseisample = ?,satsample = ?,sinfuryouhanteisya = ?,hanteinyuuryokusya = ?,toridasisya = ?,kousa1 = ?,juryou1 = ?,kosuu1 = ?,kousa2 = ?,juryou2 = ?,kosuu2 = ?,kousa3 = ?,"
                + "juryou3 = ?,kosuu3 = ?,kousa4 = ?,juryou4 = ?,kosuu4 = ?,countersousuu = ?,ryohinjuryou = ?,ryohinkosuu = ?,budomari = ?,binkakuninsya = ?,saiken = ?,setubikubun = ?,kosinnichiji = ?,"
                + "revision = ?,irhanteiti1low = ?,irhanteiti1tani = ?,irhanteiti2low = ?,irhanteiti2tani = ?,"
                + "bin1countersuu2 = ?,bin1countersuu3 = ?,bin2countersuu2 = ?,bin2countersuu3 = ?,bin3countersuu2 = ?,bin3countersuu3 = ?,bin4countersuu2 = ?,bin4countersuu3 = ?,"
                + "bin5countersuu2 = ?,bin5countersuu3 = ?,bin6countersuu2 = ?,bin6countersuu3 = ?,bin7countersuu2 = ?,bin7countersuu3 = ?,bin8countersuu2 = ?,bin8countersuu3 = ?,douhinsyu = ?,irhanteiti1tanilow = ?,irhanteiti2tanilow = ? "
                + "WHERE kojyo = ? AND lotno = ? AND edaban = ? AND kaisuu = ? AND revision = ? ";
    ...
    private List<Object> setUpdateParameterSrDenkitokuseiesi(boolean isInsert, BigDecimal newRev, String kojyo, String lotNo, String edaban,
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemList, GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU, srDenkitokuseiesi))); //最大処理数
        params.add(DBUtil.stringToIntObject(getItemData(pItemList, GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU, srDenkitokuseiesi))); //累計処理数
        ...
        params.add(DBUtil.stringToStringObject(getItemData(pItemList, GXHDO101B041Const.SEIHIN_SHITEI_KOUSA_BUDOMARI3, srDenkitokuseiesi))); //指定公差歩留まり3
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_FUKURO_CHECK, srDenkitokuseiesi))); //BIN1 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_FUKURO_CHECK, srDenkitokuseiesi))); //BIN2 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_FUKURO_CHECK, srDenkitokuseiesi))); //BIN3 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_FUKURO_CHECK, srDenkitokuseiesi))); //BIN4 袋ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, srDenkitokuseiesi))); //BIN7 抜き取り結果
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T, srDenkitokuseiesi))); //BIN7 抜き取り結果
        params.add(DBUtil.stringToBigDecimalObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, srDenkitokuseiesi))); //BIN7 真の不良率(%)
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, srDenkitokuseiesi))); //BIN7 結果ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, srDenkitokuseiesi))); //BIN8 抜き取り結果
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T, srDenkitokuseiesi))); //BIN8 抜き取り結果
        params.add(DBUtil.stringToBigDecimalObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, srDenkitokuseiesi))); //BIN8 真の不良率(%)
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_KEKKA_CHECK, srDenkitokuseiesi))); //BIN8 結果ﾁｪｯｸ
        ...
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.SET_SAT_SAMPLE, srDenkitokuseiesi))); //SATｻﾝﾌﾟﾙ
        ...
        params.add(newRev); //revision
        params.add(DBUtil.stringToBigDecimalObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値(低)
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
        params.add(DBUtil.stringToBigDecimalObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR② 判定値(低)
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, srDenkitokuseiesi))); //耐電圧設定条件 IR② 判定値 単位
        if (isInsert) {
        ...
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_COUNTER_SU2, srDenkitokuseiesi))); //BIN1 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN1_COUNTER_SU3, srDenkitokuseiesi))); //BIN1 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_COUNTER_SU2, srDenkitokuseiesi))); //BIN2 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN2_COUNTER_SU3, srDenkitokuseiesi))); //BIN2 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_COUNTER_SU2, srDenkitokuseiesi))); //BIN3 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN3_COUNTER_SU3, srDenkitokuseiesi))); //BIN3 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_COUNTER_SU2, srDenkitokuseiesi))); //BIN4 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN4_COUNTER_SU3, srDenkitokuseiesi))); //BIN4 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN5_COUNTER_SU2, srDenkitokuseiesi))); //BIN5 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN5_COUNTER_SU3, srDenkitokuseiesi))); //BIN5 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN6_COUNTER_SU2, srDenkitokuseiesi))); //BIN6 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN6_COUNTER_SU3, srDenkitokuseiesi))); //BIN6 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_COUNTER_SU2, srDenkitokuseiesi))); //BIN7 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN7_COUNTER_SU3, srDenkitokuseiesi))); //BIN7 ｶｳﾝﾀｰ数3
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_COUNTER_SU2, srDenkitokuseiesi))); //BIN8 ｶｳﾝﾀｰ数2
        params.add(DBUtil.stringToIntObject(getItemData(pItemListEx, GXHDO101B041Const.SET_BIN8_COUNTER_SU3, srDenkitokuseiesi))); //BIN8 ｶｳﾝﾀｰ数3
        params.add(getCheckBoxDbValue(getItemData(pItemList, GXHDO101B041Const.SEIHIN_DOUHINSYU, srDenkitokuseiesi), 0)); //同品種
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
        params.add(DBUtil.stringToStringObject(getItemData(pItemListEx, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, srDenkitokuseiesi))); //耐電圧設定条件 IR① 判定値 単位
        if (isInsert) {
            params.add(""); //耐電圧設定条件 IR③ 判定値 単位
            params.add(""); //耐電圧設定条件 IR④ 判定値 単位
            params.add(""); //耐電圧設定条件 IR⑤ 判定値 単位
     ...
     * @param processData 処理制御データ
     */
    private void doBuzaiZaiko(ProcessData processData) {
        try {
            
            FXHDD01 itemBuzaiNo = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_TEST_PLATE_KANRINO); //ﾃｽﾄﾌﾟﾚｰﾄ管理No
            FXHDD01 itemSaidai = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU); //最大処理数
            FXHDD01 itemRuikei = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU); //累計処理数
            ...
            String siyo_kosu = StringUtil.nullToBlank(fmlad01Data.get("siyo_kosu"));
    ...
    private void calcCounterSosu(ProcessData processData) {
        try {
            FXHDD01 itemCounterSosu = getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_COUNTER_SOSU); //計量総数

            BigDecimal suryo1 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_KEIRYOGO_SURYO, null))); //BIN1 計量後数量
            BigDecimal suryo2 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_KEIRYOGO_SURYO, null))); //BIN2 計量後数量
            BigDecimal suryo3 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_KEIRYOGO_SURYO, null))); //BIN3 計量後数量
            BigDecimal suryo4 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_KEIRYOGO_SURYO, null))); //BIN4 計量後数量
            BigDecimal suryo5 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_KEIRYOGO_SURYO, null))); //BIN5 計量後数量
            BigDecimal suryo6 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_KEIRYOGO_SURYO, null))); //BIN6 計量後数量
            BigDecimal suryo7 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_KEIRYOGO_SURYO, null))); //BIN7 計量後数量
            BigDecimal suryo8 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_KEIRYOGO_SURYO, null))); //BIN8 計量後数量
            BigDecimal suryo9 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_BIN9_K_KEIRYOGO_SURYO, null))); //BIN9 計量後数量
            BigDecimal suryo10 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_RAKKA_KEIRYOGO_SURYO, null))); //落下 計量後数量
            BigDecimal suryo11 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_HANDA_SAMPLE, null)));
            BigDecimal suryo12 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_SHINRAISEI_SAMPLE, null)));
            BigDecimal suryo13 = new BigDecimal(StringUtil.emptyToZero(getItemData(processData.getItemListEx(), GXHDO101B041Const.SET_SAT_SAMPLE, null))); 
    ...
    private void calcGosaritsu(ProcessData processData) {
        //BIN1 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_GOSARITSU, GXHDO101B041Const.SET_BIN1_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN1_COUNTER_SU, GXHDO101B041Const.SET_BIN1_COUNTER_SU2, GXHDO101B041Const.SET_BIN1_COUNTER_SU3);
        //BIN2 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_GOSARITSU, GXHDO101B041Const.SET_BIN2_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN2_COUNTER_SU, GXHDO101B041Const.SET_BIN2_COUNTER_SU2, GXHDO101B041Const.SET_BIN2_COUNTER_SU3);
        //BIN3 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_GOSARITSU, GXHDO101B041Const.SET_BIN3_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN3_COUNTER_SU, GXHDO101B041Const.SET_BIN3_COUNTER_SU2, GXHDO101B041Const.SET_BIN3_COUNTER_SU3);
        //BIN4 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_GOSARITSU, GXHDO101B041Const.SET_BIN4_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN4_COUNTER_SU, GXHDO101B041Const.SET_BIN4_COUNTER_SU2, GXHDO101B041Const.SET_BIN4_COUNTER_SU3);
        //BIN5 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_GOSARITSU, GXHDO101B041Const.SET_BIN5_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN5_COUNTER_SU, GXHDO101B041Const.SET_BIN5_COUNTER_SU2, GXHDO101B041Const.SET_BIN5_COUNTER_SU3);
        //BIN6 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_GOSARITSU, GXHDO101B041Const.SET_BIN6_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN6_COUNTER_SU, GXHDO101B041Const.SET_BIN6_COUNTER_SU2, GXHDO101B041Const.SET_BIN6_COUNTER_SU3);
        //BIN7 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_GOSARITSU, GXHDO101B041Const.SET_BIN7_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN7_COUNTER_SU, GXHDO101B041Const.SET_BIN7_COUNTER_SU2, GXHDO101B041Const.SET_BIN7_COUNTER_SU3);
        //BIN8 誤差率計算
        calcGosaritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_GOSARITSU, GXHDO101B041Const.SET_BIN8_KEIRYOGO_SURYO, GXHDO101B041Const.SET_BIN8_COUNTER_SU, GXHDO101B041Const.SET_BIN8_COUNTER_SU2, GXHDO101B041Const.SET_BIN8_COUNTER_SU3);
    ...
    private void calcGosaritsuMain(List<FXHDD01> itemListEx, String gosaritsuId, String keiryogoSuryoId, String counterSuId, String counterSuId2, String counterSuId3) {
        try {
            ...
            FXHDD01 itemCounterSu2 = getItemRow(itemListEx, counterSuId2); //カウンター数
            FXHDD01 itemCounterSu3 = getItemRow(itemListEx, counterSuId3); //カウンター数
            ...
            if (itemCounterSu2.getValue() != null && !"".equals(itemCounterSu2.getValue())) {
                counterSu = counterSu.add(new BigDecimal(itemCounterSu2.getValue()));
            }
            if (itemCounterSu3.getValue() != null && !"".equals(itemCounterSu3.getValue())) {
                counterSu = counterSu.add(new BigDecimal(itemCounterSu3.getValue()));            
            }
    ...
    private void calcShinFuryoritsu(ProcessData processData) {
        //BIN1 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN1_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN1_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN1_NUKITORIKEKKA_T);
        //BIN2 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN2_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN2_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN2_NUKITORIKEKKA_T);
        //BIN3 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN3_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN3_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN3_NUKITORIKEKKA_T);
        //BIN4 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN4_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN4_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN4_NUKITORIKEKKA_T);
        //BIN5 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN5_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN5_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN5_NUKITORIKEKKA_T);
        //BIN6 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN6_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN6_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN6_NUKITORIKEKKA_T);
        //BIN7 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN7_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T);
        //BIN8 真の不良率計算
        calcShinFuryoritsuMain(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, GXHDO101B041Const.SET_BIN8_MACHINE_FURYORITSU, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T);
    ...
    private String getSrDenkitokuseiesiItemData(String itemId, SrDenkitokuseiesi srDenkitokuseiesi) {
        switch (itemId) {
            ...
            //製品情報:最大処理数
            case GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getSaidaisyorisuu());
                
            //製品情報:累計処理数
            case GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getRuikeisyorisuu());
            ...
            //製品情報:指定公差歩留まり3
            case GXHDO101B041Const.SEIHIN_SHITEI_KOUSA_BUDOMARI3:
            ...
            //製品情報:同品種
            case GXHDO101B041Const.SEIHIN_DOUHINSYU:
            ...
            //耐電圧設定条件:IR① 判定値(低)
            case GXHDO101B041Const.TAIDEN_HANTEICHI1LOW:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getIrhanteiti1low());

            //耐電圧設定条件:IR① 判定値 単位
            case GXHDO101B041Const.TAIDEN_HANTEICHI1TANI:
            ...
            //耐電圧設定条件:IR② 判定値(低)
            case GXHDO101B041Const.TAIDEN_HANTEICHI2LOW:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getIrhanteiti2low());

            //耐電圧設定条件:IR② 判定値 単位
            case GXHDO101B041Const.TAIDEN_HANTEICHI2TANI:
            ...
            //設定条件及び処理結果:BIN1 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN1_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin1countersuu2());

            //設定条件及び処理結果:BIN1 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN1_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN1 袋ﾁｪｯｸ
            case GXHDO101B041Const.SET_BIN1_FUKURO_CHECK:
            ...
            //設定条件及び処理結果:BIN2 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN2_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin2countersuu2());

            //設定条件及び処理結果:BIN2 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN2_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN2 袋ﾁｪｯｸ
            case GXHDO101B041Const.SET_BIN2_FUKURO_CHECK:
            ...
            //設定条件及び処理結果:BIN3 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN3_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin3countersuu2());

            //設定条件及び処理結果:BIN3 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN3_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN3 袋ﾁｪｯｸ
            case GXHDO101B041Const.SET_BIN3_FUKURO_CHECK:
            ...
            //設定条件及び処理結果:BIN4 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN4_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin4countersuu2());

            //設定条件及び処理結果:BIN4 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN4_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN4 袋ﾁｪｯｸ
            case GXHDO101B041Const.SET_BIN4_FUKURO_CHECK:
            ...
            //設定条件及び処理結果:BIN5 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN5_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin5countersuu2());

            //設定条件及び処理結果:BIN5 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN5_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN6 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN6_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin6countersuu2());

            //設定条件及び処理結果:BIN6 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN6_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN7 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN7_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin7countersuu2());

            //設定条件及び処理結果:BIN7 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN7_COUNTER_SU3:
            ...
            //設定条件及び処理結果:BIN8 ｶｳﾝﾀｰ数2
            case GXHDO101B041Const.SET_BIN8_COUNTER_SU2:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getBin8countersuu2());

            //設定条件及び処理結果:BIN8 ｶｳﾝﾀｰ数3
            case GXHDO101B041Const.SET_BIN8_COUNTER_SU3:
            ...
            //設定条件及び処理結果:SATｻﾝﾌﾟﾙ
            case GXHDO101B041Const.SET_SAT_SAMPLE:
            ...
            //耐電圧設定条件:IR① 判定値(低) 単位
            case GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW:
                return StringUtil.nullToBlank(srDenkitokuseiesi.getIrhanteiti1tanilow());

            //耐電圧設定条件:IR② 判定値(低) 単位
            case GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW:
    ...
    private void insertDeleteDataTmpSrDenkitokuseiesi(QueryRunner queryRunnerQcdb, Connection conQcdb, BigDecimal newRev, int deleteflag,
        ...
        String sql = "INSERT INTO tmp_sr_denkitokuseiesi ("
                ...
                + "juryou3,kosuu3,kousa4,juryou4,kosuu4,countersousuu,ryohinjuryou,ryohinkosuu,budomari,binkakuninsya,saiken,setubikubun,torokunichiji,kosinnichiji,revision,deleteflag,"
                + "irhanteiti1low,irhanteiti1tani,irhanteiti2low,irhanteiti2tani,bin1countersuu2,bin1countersuu3,bin2countersuu2,bin2countersuu3,bin3countersuu2,bin3countersuu3,bin4countersuu2,bin4countersuu3,"
                + "bin5countersuu2,bin5countersuu3,bin6countersuu2,bin6countersuu3,bin7countersuu2,bin7countersuu3,bin8countersuu2,bin8countersuu3,douhinsyu,irhanteiti1tanilow,irhanteiti2tanilow,irhanteiti3tanilow,irhanteiti4tanilow,irhanteiti5tanilow,irhanteiti6tanilow,irhanteiti7tanilow,irhanteiti8tanilow,saidaisyorisuu,ruikeisyorisuu"
                + ") SELECT "
                + "kojyo,lotno,edaban,kaisuu,kcpno,tokuisaki,ownercode,lotkubuncode,siteikousa,atokouteisijinaiyou,okuriryouhinsuu,ukeiretannijyuryo,ukeiresoujyuryou,"
                + "gdyakitukenitiji,mekkinitiji,kensabasyo,senbetukaisinitiji,senbetusyuryounitiji,kensagouki,bunruiairatu,cdcontactatu,ircontactatu,stationcd1,stationpc1,stationpc2,"
                + "stationpc3,stationpc4,stationir1,stationir2,stationir3,stationir4,stationir5,stationir6,stationir7,stationir8,koteidenkyoku,torakkugaido,testplatekeijo,bunruifukidasi,"
    ...
    private void initGXHDO101B041B(ProcessData processData) {
        ...
        bean.setHanteichi1low(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1LOW));
        bean.setHanteichi1tani(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1TANI));
        ...
        bean.setHanteichi2low(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2LOW));
        bean.setHanteichi2tani(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2TANI));
        ...
        bean.setHanteichi1tani_low(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW));
        bean.setHanteichi2tani_low(getItemRow(processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW));
    }
    ...
    private void initGXHDO101B041D(ProcessData processData) {
        ...
        bean.setBin1CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_COUNTER_SU2));
        bean.setBin1CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_COUNTER_SU3));
        ...
        bean.setBin1FukuroCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_FUKURO_CHECK));
        ...
        bean.setBin2CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_COUNTER_SU2));
        bean.setBin2CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_COUNTER_SU3));
        ...
        bean.setBin2FukuroCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_FUKURO_CHECK));
        ...
        bean.setBin3CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_COUNTER_SU2));
        bean.setBin3CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_COUNTER_SU3));
        ...
        bean.setBin3FukuroCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_FUKURO_CHECK));
        ...
        bean.setBin4CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_COUNTER_SU2));
        bean.setBin4CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_COUNTER_SU3));
        ...
        bean.setBin4FukuroCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_FUKURO_CHECK));
        ...
        bean.setBin5CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_COUNTER_SU2));
        bean.setBin5CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_COUNTER_SU3));
        ...
        bean.setBin6CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_COUNTER_SU2));
        bean.setBin6CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_COUNTER_SU3));
        ...
        bean.setBin7CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_COUNTER_SU2));
        bean.setBin7CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_COUNTER_SU3));
        ...
        bean.setBin7NukitorikekkaS(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S));
        bean.setBin7NukitorikekkaT(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T));
        bean.setBin7ShinFuryoritsu(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU));
        bean.setBin7KekkaCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_KEKKA_CHECK));
        ...
        bean.setBin8CounterSu2(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_COUNTER_SU2));
        bean.setBin8CounterSu3(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_COUNTER_SU3));
        ...
        bean.setBin8NukitorikekkaS(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S));
        bean.setBin8NukitorikekkaT(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T));
        bean.setBin8ShinFuryoritsu(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU));
        bean.setBin8KekkaCheck(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_KEKKA_CHECK));
        ...
        bean.setSatSample(getItemRow(processData.getItemListEx(), GXHDO101B041Const.SET_SAT_SAMPLE));
    ...
    private List<String> checkExistFormItem(ProcessData processData) {
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, "・耐電圧設定条件 IR① 判定値(低)");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, "・耐電圧設定条件 IR① 判定値 単位");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, "・耐電圧設定条件 IR② 判定値(低)");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, "・耐電圧設定条件 IR② 判定値 単位");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_COUNTER_SU2, "・BIN1 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_COUNTER_SU3, "・BIN1 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN1_FUKURO_CHECK, "・BIN1 袋ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_COUNTER_SU2, "・BIN2 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_COUNTER_SU3, "・BIN2 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN2_FUKURO_CHECK, "・BIN2 袋ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_COUNTER_SU2, "・BIN3 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_COUNTER_SU3, "・BIN3 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN3_FUKURO_CHECK, "・BIN3 袋ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_COUNTER_SU2, "・BIN4 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_COUNTER_SU3, "・BIN4 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN4_FUKURO_CHECK, "・BIN4 袋ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_COUNTER_SU2, "・BIN5 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN5_COUNTER_SU3, "・BIN5 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_COUNTER_SU2, "・BIN6 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN6_COUNTER_SU3, "・BIN6 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_COUNTER_SU2, "・BIN7 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_COUNTER_SU3, "・BIN7 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_S, "・BIN7 抜き取り結果");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_NUKITORIKEKKA_T, "・BIN7 抜き取り結果");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_SHIN_FURYORITSU, "・BIN7 真の不良率(%)");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, "・BIN7 結果ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_COUNTER_SU2, "・BIN8 ｶｳﾝﾀｰ数2");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_COUNTER_SU3, "・BIN8 ｶｳﾝﾀｰ数3");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_S, "・BIN8 抜き取り結果");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_NUKITORIKEKKA_T, "・BIN8 抜き取り結果");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_SHIN_FURYORITSU, "・BIN8 真の不良率(%)");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_BIN8_KEKKA_CHECK, "・BIN8 結果ﾁｪｯｸ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_SAT_SAMPLE, "・SATｻﾝﾌﾟﾙ");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.SET_COUNTER_SOSU, "・計量総数");
        ...
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, "・耐電圧設定条件 IR① 判定値(低) 単位");
        checkExistItem(errorItemNameList, processData.getItemListEx(), GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, "・耐電圧設定条件 IR② 判定値(低) 単位");
    ...
    private ErrorMessageInfo checkItemResistCorrect(ProcessData processData) {
        ...
        String warningMassage = checkKekkaCheck(processData, new String[]{GXHDO101B041Const.SET_BIN1_KEKKA_CHECK, GXHDO101B041Const.SET_BIN2_KEKKA_CHECK, GXHDO101B041Const.SET_BIN3_KEKKA_CHECK,
            GXHDO101B041Const.SET_BIN4_KEKKA_CHECK, GXHDO101B041Const.SET_BIN5_KEKKA_CHECK, GXHDO101B041Const.SET_BIN6_KEKKA_CHECK, GXHDO101B041Const.SET_BIN7_KEKKA_CHECK, GXHDO101B041Const.SET_BIN8_KEKKA_CHECK});
    ...
    private List<FXHDD07> loadFXHDD07(QueryRunner queryRunnerDoc, String lotNo) throws SQLException {
        ...
        String sql = "SELECT kojyo,lotno,edaban,gouki,bunruiairatu,cdcontactatu,ircontactatu,tan,"
                ...
                + "irhantei1tani,irjudenjikan1,irdenatu2,irhanteiti2_low,irhanteiti2,irhantei2tani,"
                + "irjudenjikan2,irdenatu3,irhanteiti3_low,irhanteiti3,irhantei3tani,irjudenjikan3,"
                + "irdenatu4,irhanteiti4_low,irhanteiti4,irhantei4tani,irjudenjikan4,irdenatu5,"
                + "irhanteiti5_low,irhanteiti5,irhantei5tani,irjudenjikan5,irdenatu6,irhanteiti6_low,"
                + "irhanteiti6,irhantei6tani,irjudenjikan6,irdenatu7,irhanteiti7_low,irhanteiti7,"
                + "irhantei7tani,irjudenjikan7,irdenatu8,irhanteiti8_low,irhanteiti8,irhantei8tani,"
        ...
        mapping.put("irhantei1tani_low", "irhantei1tani_low");
        mapping.put("irhantei2tani_low", "irhantei2tani_low");
        mapping.put("irhantei3tani_low", "irhantei3tani_low");
        mapping.put("irhantei4tani_low", "irhantei4tani_low");
        mapping.put("irhantei5tani_low", "irhantei5tani_low");
        mapping.put("irhantei6tani_low", "irhantei6tani_low");
        mapping.put("irhantei7tani_low", "irhantei7tani_low");
        mapping.put("irhantei8tani_low", "irhantei8tani_low");
        mapping.put("denkyokuseisou", "denkyokuseisou");
        mapping.put("setteicap4", "setteicap4");
        mapping.put("setteiti4low", "setteiti4low");
        mapping.put("setteiti4up", "setteiti4up");
    ...
    private void setSetsubiData(ProcessData processData, FXHDD07 fxhdd07) {
        ...
        //製品情報
        setItemData(processData, GXHDO101B041Const.SEIHIN_KENSA_GOKI, StringUtil.nullToBlank(fxhdd07.getGouki())); //検査号機
        setItemData(processData, GXHDO101B041Const.SEIHIN_BUNRUI_AIR_ATSU, StringUtil.nullToBlank(fxhdd07.getBunruiairatu())); //分類ｴｱｰ圧
        if (fxhdd07.getSenbetujunjo() != null && !"".equals(fxhdd07.getSenbetujunjo())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_SENBETSU, StringUtil.nullToBlank(fxhdd07.getSenbetujunjo())); //選別順序変更 
        }
        if (fxhdd07.getSetteikakunin() != null && !"".equals(fxhdd07.getSetteikakunin())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_SET_MODE_KAKUNIN, StringUtil.nullToBlank(fxhdd07.getSetteikakunin())); //設定ﾓｰﾄﾞ確認
        }
        if (fxhdd07.getHaisenkakunin() != null && !"".equals(fxhdd07.getHaisenkakunin())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_HAISENKAKUNIN, StringUtil.nullToBlank(fxhdd07.getHaisenkakunin())); //配線確認
        }
        if (fxhdd07.getKoteidenkyoku() != null && !"".equals(fxhdd07.getKoteidenkyoku())) {
        setItemData(processData, GXHDO101B041Const.SEIHIN_K_GAIKAN_DANSA, StringUtil.nullToBlank(fxhdd07.getKoteidenkyoku())); //固定電極 外観・段差 
        }
        if (fxhdd07.getTestplatekeijo() != null && !"".equals(fxhdd07.getTestplatekeijo())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_TEST_PLATE_KEIJO_SEISOU, StringUtil.nullToBlank(fxhdd07.getTestplatekeijo())); //ﾃｽﾄﾌﾟﾚｰﾄ　形状・清掃
        }
        if (fxhdd07.getBunruifukidasi() != null && !"".equals(fxhdd07.getBunruifukidasi())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_BUNRUI_FUKIDASHIANA, StringUtil.nullToBlank(fxhdd07.getBunruifukidasi())); //分類吹き出し穴 
        }
        if (fxhdd07.getTestplatekakunin() != null && !"".equals(fxhdd07.getTestplatekakunin())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_TEST_PLATE_ICHI_KAKUNIN, StringUtil.nullToBlank(fxhdd07.getTestplatekakunin())); //ﾃｽﾄﾌﾟﾚｰﾄ位置確認(穴位置) 
        }
        if (fxhdd07.getSeihintounyuujotai() != null && !"".equals(fxhdd07.getSeihintounyuujotai())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_SEIHIN_TOUNYU_JOTAI, StringUtil.nullToBlank(fxhdd07.getSeihintounyuujotai())); //製品投入状態 
        }
        if (fxhdd07.getTestplatekanrino() != null && !"".equals(fxhdd07.getTestplatekanrino())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_TEST_PLATE_KANRINO, StringUtil.nullToBlank(fxhdd07.getTestplatekanrino())); //ﾃｽﾄﾌﾟﾚｰﾄ管理No        
        }
        setItemData(processData, GXHDO101B041Const.SEIHIN_TAN_DELTA, StringUtil.nullToBlank(fxhdd07.getTan())); //Tanδ
        setItemData(processData, GXHDO101B041Const.SEIHIN_SOKUTEI_SHUHASU, StringUtil.nullToBlank(fxhdd07.getSokuteisyuhasuu())); //測定周波数
        setItemData(processData, GXHDO101B041Const.SEIHIN_SOKUTEI_DENATSU, StringUtil.nullToBlank(fxhdd07.getSokuteidenatu())); //測定電圧
        if (fxhdd07.getBunruikakunin() != null && !"".equals(fxhdd07.getBunruikakunin())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_BUNRUI_KAKUNIN, StringUtil.nullToBlank(fxhdd07.getBunruikakunin())); //分類確認
        }
        if (fxhdd07.getGaikankakunin() != null && !"".equals(fxhdd07.getGaikankakunin())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_GAIKAN_KAKUNIN, StringUtil.nullToBlank(fxhdd07.getGaikankakunin())); //外観確認
        }
        if (fxhdd07.getDenkyokuseisou() != null && !"".equals(fxhdd07.getDenkyokuseisou())) {
            setItemData(processData, GXHDO101B041Const.SEIHIN_DENKYOKU_SEISOU_DOUSA, StringUtil.nullToBlank(fxhdd07.getDenkyokuseisou())); //電極清掃・動作
        }
        ...
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1LOW, StringUtil.nullToBlank(fxhdd07.getIrhanteiti1Low())); //耐電圧設定条件 IR① 判定値(低)
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI, StringUtil.nullToBlank(fxhdd07.getIrhantei1tani())); //耐電圧設定条件 IR① 判定値 単位
        ...
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2LOW, StringUtil.nullToBlank(fxhdd07.getIrhanteiti2Low())); //耐電圧設定条件 IR② 判定値(低)
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI, StringUtil.nullToBlank(fxhdd07.getIrhantei2tani())); //耐電圧設定条件 IR② 判定値 単位
        ...
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI1TANI_LOW, StringUtil.nullToBlank(fxhdd07.getIrhantei1tani_low())); //耐電圧設定条件 IR① 判定値(低) 単位
        setItemDataEx(processData, GXHDO101B041Const.TAIDEN_HANTEICHI2TANI_LOW, StringUtil.nullToBlank(fxhdd07.getIrhantei2tani_low())); //耐電圧設定条件 IR① 判定値(低) 単位
        ...
        if (fxhdd07.getHandasample() != null && !"".equals(fxhdd07.getHandasample())) {
            setItemDataEx(processData, GXHDO101B041Const.SET_HANDA_SAMPLE, StringUtil.nullToBlank(fxhdd07.getHandasample())); //半田ｻﾝﾌﾟﾙ
        }
        if (fxhdd07.getSinraiseisample() != null && !"".equals(fxhdd07.getSinraiseisample())) {
            setItemDataEx(processData, GXHDO101B041Const.SET_SHINRAISEI_SAMPLE, StringUtil.nullToBlank(fxhdd07.getSinraiseisample())); //信頼性ｻﾝﾌﾟﾙ
        }
    ...
    public ProcessData confUkeireSojuryoKeisan(ProcessData processData) {
        ...
        if (!checkUkeireSojuryo(getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_SOUJURYO),
                getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_OKURI_RYOHINSU),
                getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_TANNIJURYO))) {
            return processData;
        }

        // 受入総重量が入力されている場合は警告メッセージを表示
        if (!StringUtil.isEmpty(getItemData(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_SOUJURYO, null))) {
            // 警告メッセージの設定
    ...
    public ProcessData doUkeireSojuryoKeisan(ProcessData processData) {
        ...
        //受入総重量計算処理
        calcUkeireSojuryo(getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_SOUJURYO),
                getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_OKURI_RYOHINSU),
                getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_UKEIRE_TANNIJURYO));
     ...
     * @return BINX カウンター数
     */
    private Integer getBinXCountor(int i, FXHDD07 fxhdd07) {
        switch (i) {
            case 1:
                return fxhdd07.getBin1countersuu();
            case 2:
                return fxhdd07.getBin2countersuu();
            case 3:
                return fxhdd07.getBin3countersuu();
            case 4:
                return fxhdd07.getBin4countersuu();
            case 5:
                return fxhdd07.getBin5countersuu();
            case 6:
                return fxhdd07.getBin6countersuu();
            case 7:
                return fxhdd07.getBin7countersuu();
            case 8:
                return fxhdd07.getBin8countersuu();
        }
        return null;
    }
    ...
    private String getBinXCounterItemName(int i, int j) {
        switch (i) {
            case 1:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN1_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN1_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN1_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 2:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN2_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN2_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN2_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 3:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN3_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN3_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN3_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 4:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN4_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN4_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN4_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 5:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN5_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN5_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN5_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 6:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN6_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN6_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN6_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 7:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN7_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN7_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN7_COUNTER_SU3;
                    default:
                        break;
                }   break;
            case 8:
                switch (j) {
                    case 1:
                        return GXHDO101B041Const.SET_BIN8_COUNTER_SU;
                    case 2:
                        return GXHDO101B041Const.SET_BIN8_COUNTER_SU2;
                    case 3:
                        return GXHDO101B041Const.SET_BIN8_COUNTER_SU3;
                    default:
                        break;
                }   break;
            default:
    ...
    private void setBinXPercentKbn(ProcessData processData, FXHDD07 fxhdd07) {
        ...
        Integer setteicap4 = fxhdd07.getSetteicap4();
        ...
        String setteiti4low = fxhdd07.getSetteiti4low();
        String setteiti4up = fxhdd07.getSetteiti4up();        
        if (setteicap4 != null) {
            String itemName4 = getBinXPercentKbnItemName(setteicap4);
            if (!StringUtil.isEmpty(itemName4) && !NumberUtil.isZeroOrEmpty(setteiti4low) && !NumberUtil.isZeroOrEmpty(setteiti4up)) {
                setItemDataEx(processData, itemName4, setteiti4low + "～" + setteiti4up); // BINX %区分(設定値)
            }
        }
    ...
    private String getBinXPercentKbnItemName(Integer setteicap) {
        switch (setteicap) {
            case 1:
                return GXHDO101B041Const.SET_BIN1_PERCENT_KBN;
            case 2:
                return GXHDO101B041Const.SET_BIN2_PERCENT_KBN;
            case 3:
                return GXHDO101B041Const.SET_BIN3_PERCENT_KBN;
            case 4:
                return GXHDO101B041Const.SET_BIN4_PERCENT_KBN;
            case 5:
                return GXHDO101B041Const.SET_BIN5_PERCENT_KBN;
            case 6:
                return GXHDO101B041Const.SET_BIN6_PERCENT_KBN;
            case 7:
                return GXHDO101B041Const.SET_BIN7_PERCENT_KBN;
            case 8:
                return GXHDO101B041Const.SET_BIN8_PERCENT_KBN;
        }
    ...
    private String doPMLA0212Save(ProcessData processData, String tantoshaCd) {
        ...
        doCallPmla0212Api(processData, tantoshaCd, GXHDO101B041Const.SEIHIN_TEST_PLATE_KANRINO, GXHDO101B041Const.SEIHIN_OKURI_RYOHINSU, errorItemList);
    ...
    private boolean isSaidaisyorisuu(ProcessData processData) {
        ...
        FXHDD01 itemFxhdd01ryohinsuu = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_OKURI_RYOHINSU);
        ...
        FXHDD01 itemFxhdd01saidaisyorisuu = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_SAIDAI_SYORISUU);
        ...
        FXHDD01 itemFxhdd01ruikeisyorisuu = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_RUIKEI_SYORISUU);
     ...
     * @param processData 処理制御データ
     * @param tantoshaCd 更新者
     * @param kanrinoStr ﾃｽﾄﾌﾟﾚｰﾄ管理No
     * @param ryouhinsuuStr 良品数
     * @return レスポンスデータ
     */
    private void doCallPmla0212Api(ProcessData processData, String tantoshaCd, String kanrinoStr, String ryouhinsuuStr, ArrayList<String> errorItemList) {
        ...
        FXHDD01 itemFxhdd01Lotno = getItemRow(processData.getItemList(), GXHDO101B041Const.SEIHIN_LOTNO);
        ...
        paramsList.add("GXHDO101B041");
        paramsList.add(null);
        paramsList.add(null);
        paramsList.add(null);
        paramsList.add(ryohinsuuValue);
