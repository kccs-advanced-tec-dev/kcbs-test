 ...
 */
/**
 * SR_SLIP_FP_BAKETSU(ｽﾘｯﾌﾟ作製・FP(ﾊﾞｹﾂ))のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/12/15
 */
public class SrSlipFpBaketsu {
     ...
     * 排出容器の内袋
     */
    private Integer haisyutsuyouki;

    /**
     * 風袋重量①
     */
    private Integer hutaijyuuryou1;

    /**
     * 風袋重量②
     */
    private Integer hutaijyuuryou2;

    /**
     * 風袋重量③
     */
    private Integer hutaijyuuryou3;

    /**
     * 風袋重量④
     */
    private Integer hutaijyuuryou4;

    /**
     * 風袋重量⑤
     */
    private Integer hutaijyuuryou5;

    /**
     * 風袋重量⑥
     */
    private Integer hutaijyuuryou6;
     ...
     * ﾌｨﾙﾀｰ取り付け_取り付け本数1
     */
    private Integer filtertoritsuketoritsukehonsuu1;
     ...
     * ﾌｨﾙﾀｰ取り付け_取り付け本数2
     */
    private Integer filtertoritsuketoritsukehonsuu2;
     ...
     * 圧送ﾀﾝｸNo
     */
    private Integer assoutankno;

    /**
     * F/P開始日時
     */
    private Timestamp fpkaishinichiji;
     ...
     * 圧送圧力
     */
    private BigDecimal assouatsuryoku;
     ...
     * ﾌｨﾙﾀｰ交換①_F/P停止日時
     */
    private Timestamp filterkoukan1fpteishinichiji;
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数1
     */
    private Integer filterkoukan1toritsukehonnsuu1;
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数2
     */
    private Integer filterkoukan1toritsukehonnsuu2;
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数3
     */
    private Integer filterkoukan1toritsukehonnsuu3;

    /**
     * ﾌｨﾙﾀｰ交換①_F/P再開日時
     */
    private Timestamp filterkoukan1fpsaikainichiji;
     ...
     * F/P終了日時
     */
    private Timestamp fpsyuryounichiji;
     ...
     * 総重量1
     */
    private Integer soujyuryou1;

    /**
     * 総重量2
     */
    private Integer soujyuryou2;

    /**
     * 総重量3
     */
    private Integer soujyuryou3;

    /**
     * 総重量4
     */
    private Integer soujyuryou4;

    /**
     * 総重量5
     */
    private Integer soujyuryou5;

    /**
     * 総重量6
     */
    private Integer soujyuryou6;

    /**
     * 正味重量1
     */
    private Integer syoumijyuuryou1;

    /**
     * 正味重量2
     */
    private Integer syoumijyuuryou2;

    /**
     * 正味重量3
     */
    private Integer syoumijyuuryou3;

    /**
     * 正味重量4
     */
    private Integer syoumijyuuryou4;

    /**
     * 正味重量5
     */
    private Integer syoumijyuuryou5;

    /**
     * 正味重量6
     */
    private Integer syoumijyuuryou6;

    /**
     * ｽﾘｯﾌﾟ重量合計
     */
    private Integer slipjyuuryougoukei;
     ...
     * ﾌｨﾙﾀｰ取り付け_1次ﾌｨﾙﾀｰ品名
     *
     * @param filtertoritsuke1filterhinmei the filtertoritsuke1filterhinmei to
     * set
     */
     ...
     * ﾌｨﾙﾀｰ取り付け_取り付け本数1
     *
     * @param filtertoritsuketoritsukehonsuu1 the
     * filtertoritsuketoritsukehonsuu1 to set
     */
     ...
     * ﾌｨﾙﾀｰ取り付け_2次ﾌｨﾙﾀｰ品名
     *
     * @param filtertoritsuke2filterhinmei the filtertoritsuke2filterhinmei to
     * set
     */
     ...
     * ﾌｨﾙﾀｰ取り付け_取り付け本数2
     *
     * @param filtertoritsuketoritsukehonsuu2 the
     * filtertoritsuketoritsukehonsuu2 to set
     */
     ...
     * ﾌｨﾙﾀｰ交換①_F/P停止日時
     *
     * @param filterkoukan1fpteishinichiji the filterkoukan1fpteishinichiji to
     * set
     */
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数1
     *
     * @param filterkoukan1toritsukehonnsuu1 the filterkoukan1toritsukehonnsuu1
     * to set
     */
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数2
     *
     * @param filterkoukan1toritsukehonnsuu2 the filterkoukan1toritsukehonnsuu2
     * to set
     */
     ...
     * ﾌｨﾙﾀｰ交換①_取り付け本数3
     *
     * @param filterkoukan1toritsukehonnsuu3 the filterkoukan1toritsukehonnsuu3
     * to set
     */
     ...
     * ﾌｨﾙﾀｰ交換①_F/P再開日時
     *
     * @param filterkoukan1fpsaikainichiji the filterkoukan1fpsaikainichiji to
     * set
     */
