 ...
 */
/**
 * GXHDO102C009Model(誘電体ｽﾗﾘｰ作製・溶剤・添加材ｽﾗﾘｰ秤量入力サブ画面用)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/11/09
 */
public class GXHDO102C009Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C009Model clone() throws CloneNotSupportedException {
        return (GXHDO102C009Model) super.clone();
    }
    ...
    /**
     * 分散材1_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen1;

    /**
     * 分散材2_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen2;

    /**
     * 溶剤1_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen3;

    /**
     * 溶剤2_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen4;

    /**
     * 溶剤3_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen5;

    /**
     * 溶剤4_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen6;

    /**
     * 溶剤5_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen7;

    /**
     * 溶剤6_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen8;

    /**
     * 溶剤7_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen9;

    /**
     * 溶剤8_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen10;

    /**
     * 溶剤9_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen11;

    /**
     * コンストラクタ
     */
    public GXHDO102C009Model() {
    ...
    /**
     * 溶剤8_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     * @return the subgamen10
     */
    public SubGamenData getSubgamen10() {
        return subgamen10;
    }

    /**
     * 溶剤8_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     * @param subgamen10 the subgamen10 to set
     */
    public void setSubgamen10(SubGamenData subgamen10) {
        this.subgamen10 = subgamen10;
    }

    /**
     * 溶剤9_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     * @return the subgamen11
     */
    public SubGamenData getSubgamen11() {
        return subgamen11;
    }

    /**
     * 溶剤9_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     * @param subgamen11 the subgamen11 to set
     */
    public void setSubgamen11(SubGamenData subgamen11) {
        this.subgamen11 = subgamen11;
    }

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面データ
     */
