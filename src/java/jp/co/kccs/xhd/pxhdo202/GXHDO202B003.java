            ...
            if(null != cmbKotei)switch (cmbKotei) {
                ...
                case "予備混合(ﾌﾟﾚﾐｷｼﾝｸﾞ)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", ponpu"
                            + ", desupakaitensuu"
                            + ", (CASE WHEN tounyu1 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyu1"
                            + ", (CASE WHEN tounyu2 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyu2"
                            + ", totyukakuhanjikan"
                            + ", totyukakuhankaisinichiji"
                            + ", totyukakuhansyuryonichiji"
                            + ", (CASE WHEN tonyu3 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tonyu3"
                            + ", (CASE WHEN tonyu4 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tonyu4"
                            + ", (CASE WHEN tonyu5 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tonyu5"
                            + ", kakuhanjikan"
                            + ", kakuhankaisinichiji"
                            + ", kakuhansyuryonichiji"
                            + ", (CASE WHEN kaitentai = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS kaitentai"
                            + ", tantousya"
                            + ", kakuninsya"
                            + ", bikou1"
                            + ", bikou2 "
