...
public class GXHDO102B016 implements IFormLogic {
    ...
    public ProcessData openC008SubGamen1(ProcessData processData) {
        ...
        return openC008SubGamen(processData, 1, returnItemIdList, GXHDO102B016Const.BINDERJYUSI1_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC008SubGamen2(ProcessData processData) {
        ...
        return openC008SubGamen(processData, 2, returnItemIdList, GXHDO102B016Const.BINDERJYUSI2_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC008SubGamen3(ProcessData processData) {
        ...
        return openC008SubGamen(processData, 3, returnItemIdList, GXHDO102B016Const.YOUZAI1_TYOUGOURYOUKIKAKU);
    }
    ...
    public ProcessData openC008SubGamen4(ProcessData processData) {
        ...
        return openC008SubGamen(processData, 4, returnItemIdList, GXHDO102B016Const.YOUZAI2_TYOUGOURYOUKIKAKU);
    }
     ...
     * @return 処理制御データ
     */
    public ProcessData openC008SubGamen(ProcessData processData, int zairyokubun, List<String> returnItemIdList,String itemTyougouryoukikaku) {
        try {
            // 「秤量号機」
    ...
    private void setInputItemDataSubFormC008(ProcessData processData, List<SubSrBinderPowder> subSrBinderPowderList) {
        ...
        if (subSrBinderPowderList == null) {
            ...
            subgamen1.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B016Const.BINDERJYUSI1_TYOUGOURYOUKIKAKU).getStandardPattern()); // ﾊﾞｲﾝﾀﾞｰ樹脂1_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen2.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B016Const.BINDERJYUSI2_TYOUGOURYOUKIKAKU).getStandardPattern()); // ﾊﾞｲﾝﾀﾞｰ樹脂2_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen3.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B016Const.YOUZAI1_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤1_調合量規格情報ﾊﾟﾀｰﾝ
            ...
            subgamen4.setStandardpattern(getItemRow(processData.getItemList(), GXHDO102B016Const.YOUZAI2_TYOUGOURYOUKIKAKU).getStandardPattern()); // 溶剤2_調合量規格情報ﾊﾟﾀｰﾝ
