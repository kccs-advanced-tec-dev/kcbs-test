 ...
 */
/**
 * GXHDO102C007(ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力)
 *
 * @author KCSS wxf
 * @since 2021/11/02
 */
@ManagedBean(name = "beanGXHDO102C007")
@SessionScoped
public class GXHDO102C007 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C007.class.getName());
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ
     */
    private GXHDO102C007Model gxhdO102c007Model;

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C007Model gxhdO102c007ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C007Logic.setSubgamenDataFromView(this.getGxhdO102c007ModelView(), this.getGxhdO102c007Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C007Model.SubGamenData showsubgamendata = this.getGxhdO102c007ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C007Logic.clearBackColor(this.getGxhdO102c007ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c007ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C007Logic.calcTyogouzanryou(this.getGxhdO102c007ModelView());
        GXHDO102C007Logic.setShowsubgamendataFromView(this.getGxhdO102c007ModelView(), this.getGxhdO102c007Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c007ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c007ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C007Model gxhdo102c007model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面
     * @param errorId エラーID
     ...
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ
     *
     * @return the gxhdO102c007Model
     */
    public GXHDO102C007Model getGxhdO102c007Model() {
     ...
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ
     *
     * @param gxhdO102c007Model the gxhdO102c007Model to set
     */
    public void setGxhdO102c007Model(GXHDO102C007Model gxhdO102c007Model) {
        this.gxhdO102c007Model = gxhdO102c007Model;
    }

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c007ModelView
     */
    public GXHDO102C007Model getGxhdO102c007ModelView() {
        return gxhdO102c007ModelView;
    }

    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・溶剤秤量入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c007ModelView the gxhdO102c007ModelView to set
     */
    public void setGxhdO102c007ModelView(GXHDO102C007Model gxhdO102c007ModelView) {
        this.gxhdO102c007ModelView = gxhdO102c007ModelView;
    }
}
