...
@Named
@ViewScoped
public class GXHDO202A implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(GXHDO202A.class.getName());
        ...
        if (0 == userGrpList.size()) {
            ...
            try {
                ...
                String sql = "SELECT gamen_id, gamen_title, title_setting, link_char, menu_name, menu_comment, menu_parameter, gamen_classname, hyouji_kensu FROM fxhdm01 "
                           + "WHERE menu_group_id = 'rireki_mk' AND " 
