 ...
 */
/**
 * SR_SLIP_SLURRYKOKEIBUNTYOUSEI_SIROPORI(ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(白ﾎﾟﾘ))のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/12/06
 */
public class SrSlipSlurrykokeibuntyouseiSiropori {
    /**
     * 工場ｺｰﾄﾞ
     */
     ...
     * ｽﾗﾘｰLotNo①
     */
    private Integer slurrylotno1;

    /**
     * ｽﾗﾘｰLotNo②
     */
    private Integer slurrylotno2;

    /**
     * ｽﾗﾘｰLotNo③
     */
    private Integer slurrylotno3;
     ...
     * ｽﾗﾘｰ重量①
     */
    private Integer slurryjyuuryou1;

    /**
     * ｽﾗﾘｰ重量②
     */
    private Integer slurryjyuuryou2;

    /**
     * ｽﾗﾘｰ重量③
     */
    private Integer slurryjyuuryou3;

    /**
     * ｽﾗﾘｰ重量④
     */
    private Integer slurryjyuuryou4;

    /**
     * ｽﾗﾘｰ重量⑤
     */
    private Integer slurryjyuuryou5;

    /**
     * ｽﾗﾘｰ重量⑥
     */
    private Integer slurryjyuuryou6;

    /**
     * ｽﾗﾘｰ合計重量
     */
    private Integer slurrygoukeijyuuryou;
     ...
     * 固形分調整量➀
     */
    private Integer kokeibuntyouseiryou1;

    /**
     * 固形分調整量➁
     */
    private Integer kokeibuntyouseiryou2;

    /**
     * 固形分調整量
     */
    private Integer kokeibuntyouseiryou;

    /**
     * ﾄﾙｴﾝ添加量
     */
    private Integer toluenetenkaryou;

    /**
     * ｿﾙﾐｯｸｽ添加量
     */
    private Integer solmixtenkaryou;
