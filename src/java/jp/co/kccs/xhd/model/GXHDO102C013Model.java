 ...
 */
/**
 * GXHDO102C013Model(ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)_ｻﾌﾞ画面用)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/12/06
 */
public class GXHDO102C013Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C013Model clone() throws CloneNotSupportedException {
        return (GXHDO102C013Model) super.clone();
    }
    ...
    /**
     * 2回目溶剤1_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen3;

    /**
     * 2回目溶剤2_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
