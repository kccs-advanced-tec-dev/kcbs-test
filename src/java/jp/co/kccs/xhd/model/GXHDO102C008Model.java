 ...
 */
/**
 * GXHDO102C008Model(ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面用)のモデルクラスです。
 *
 * @author KCSS wxf
 * @since 2021/11/02
 */
public class GXHDO102C008Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C008Model clone() throws CloneNotSupportedException {
        return (GXHDO102C008Model) super.clone();
    }
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ樹脂①_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    ...
    /**
     * 溶剤①_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    ...
    /**
     * ﾊﾞｲﾝﾀﾞｰ溶液作製・ﾊﾞｲﾝﾀﾞｰ粉秤量入力サブ画面データ
     */
