 ...
 */
/**
 * SR_YUUDENTAI_TENKAZAI(誘電体ｽﾗﾘｰ作製・添加材ｽﾗﾘｰ固形分測定)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/11/07
 */
public class SrYuudentaiTenkazai {
    /**
     * 工場ｺｰﾄﾞ
     */
     ...
     * 風袋重量①
     */
    private BigDecimal fuutaijyuuryou1;

    /**
     * 風袋重量②
     */
    private BigDecimal fuutaijyuuryou2;

    /**
     * 風袋重量③
     */
    private BigDecimal fuutaijyuuryou3;

    /**
     * 総重量①
     */
    private Integer soujyuuryou1;

    /**
     * 総重量②
     */
    private Integer soujyuuryou2;

    /**
     * 総重量③
     */
    private Integer soujyuuryou3;

    /**
     * 添加材ｽﾗﾘｰ重量
     */
    private Integer tenkazaislurryjyuuryou;
     ...
     * ｱﾙﾐ皿風袋重量①
     */
    private BigDecimal arumizarafuutaijyuuryou1;

    /**
     * 乾燥前ｽﾗﾘｰ重量①
     */
    private BigDecimal kansoumaeslurryjyuuryou1;

    /**
     * ｱﾙﾐ皿風袋重量②
     */
    private BigDecimal arumizarafuutaijyuuryou2;

    /**
     * 乾燥前ｽﾗﾘｰ重量②
     */
    private BigDecimal kansoumaeslurryjyuuryou2;

    /**
     * ｱﾙﾐ皿風袋重量③
     */
    private BigDecimal arumizarafuutaijyuuryou3;

    /**
     * 乾燥前ｽﾗﾘｰ重量③
     */
    private BigDecimal kansoumaeslurryjyuuryou3;
     ...
     * 乾燥後総重量①
     */
    private BigDecimal kansougosoujyuuryou1;

    /**
     * 乾燥後総重量②
     */
    private BigDecimal kansougosoujyuuryou2;

    /**
     * 乾燥後総重量③
     */
    private BigDecimal kansougosoujyuuryou3;

    /**
     * 乾燥後正味重量①
     */
    private BigDecimal kansougosyoumijyuuryou1;

    /**
     * 乾燥後正味重量②
     */
    private BigDecimal kansougosyoumijyuuryou2;

    /**
     * 乾燥後正味重量③
     */
    private BigDecimal kansougosyoumijyuuryou3;

    /**
     * 固形分比率①
     */
    private BigDecimal kokeibunhiritu1;

    /**
     * 固形分比率②
     */
    private BigDecimal kokeibunhiritu2;

    /**
     * 固形分比率③
     */
    private BigDecimal kokeibunhiritu3;

    /**
     * 固形分比率平均
     */
    private BigDecimal kokeibunhirituheikin;
