 ...
 */
/**
 * GXHDO102C016Model(ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/12/14
 */
public class GXHDO102C016Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C016Model clone() throws CloneNotSupportedException {
        return (GXHDO102C016Model) super.clone();
    }
