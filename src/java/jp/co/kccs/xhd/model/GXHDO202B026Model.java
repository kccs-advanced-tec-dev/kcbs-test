 ...
 */
/**
 * 誘電体ｽﾗﾘｰ作製・ﾌｨﾙﾀｰﾊﾟｽ・保管履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/11/23
 */
public class GXHDO202B026Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** 風袋重量測定_ｽﾃﾝ容器1 */
    private Integer fuutaijyuuryousokutei_sutenyouki1 = null;

    /** 風袋重量測定_ｽﾃﾝ容器2 */
    private Integer fuutaijyuuryousokutei_sutenyouki2 = null;

    /** 風袋重量測定_ｽﾃﾝ容器3 */
    private Integer fuutaijyuuryousokutei_sutenyouki3 = null;

    /** 風袋重量測定_ｽﾃﾝ容器4 */
    private Integer fuutaijyuuryousokutei_sutenyouki4 = null;

    /** 風袋重量測定_ｽﾃﾝ容器5 */
    private Integer fuutaijyuuryousokutei_sutenyouki5 = null;

    /** 風袋重量測定_ｽﾃﾝ容器6 */
    private Integer fuutaijyuuryousokutei_sutenyouki6 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器1 */
    private Integer fuutaijyuuryousokutei_siropori1 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器2 */
    private Integer fuutaijyuuryousokutei_siropori2 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器3 */
    private Integer fuutaijyuuryousokutei_siropori3 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器4 */
    private Integer fuutaijyuuryousokutei_siropori4 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器5 */
    private Integer fuutaijyuuryousokutei_siropori5 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器6 */
    private Integer fuutaijyuuryousokutei_siropori6 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器7 */
    private Integer fuutaijyuuryousokutei_siropori7 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器8 */
    private Integer fuutaijyuuryousokutei_siropori8 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器9 */
    private Integer fuutaijyuuryousokutei_siropori9 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器10 */
    private Integer fuutaijyuuryousokutei_siropori10 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器11 */
    private Integer fuutaijyuuryousokutei_siropori11 = null;

    /** 風袋重量測定_白ﾎﾟﾘ容器12 */
    private Integer fuutaijyuuryousokutei_siropori12 = null;
    ...
    /** ﾌｨﾙﾀｰ取り付け_取り付け本数1 */
    private Integer filtertorituke_toritukehonsuu1 = null;
    ...
    /** ﾌｨﾙﾀｰ取り付け_取り付け本数2 */
    private Integer filtertorituke_toritukehonsuu2 = null;
    ...
    /** ﾌｨﾙﾀｰ取り付け_取り付け本数3 */
    private Integer filtertorituke_toritukehonsuu3 = null;
    ...
    /** ﾌｨﾙﾀｰ交換①_F/P停止日時 */
    private Timestamp filterkoukan1_Fpteisinichiji = null;
    ...
    /** ﾌｨﾙﾀｰ交換①_取り付け本数1 */
    private Integer filterkoukan1_toritukehonsuu1 = null;
    ...
    /** ﾌｨﾙﾀｰ交換①_取り付け本数2 */
    private Integer filterkoukan1_toritukehonsuu2 = null;
    ...
    /** ﾌｨﾙﾀｰ交換①_取り付け本数3 */
    private Integer filterkoukan1_toritukehonsuu3 = null;

    /** ﾌｨﾙﾀｰ交換①_F/P再開日時 */
    private Timestamp filterkoukan1_Fpsaikainichiji = null;
    ...
    /** 1次ﾌｨﾙﾀｰ総使用本数 */
    private Integer itijifiltersousiyouhonsuu = null;

    /** 2次ﾌｨﾙﾀｰ総使用本数 */
    private Integer nijifiltersousiyouhonsuu = null;

    /** 3次ﾌｨﾙﾀｰ総使用本数 */
    private Integer sanjifiltersousiyouhonsuu = null;

    /** ﾌｨﾙﾀｰﾊﾟｽ終了_担当者 */
    private String filterpasssyuuryou_tantousya = "";

    /** 総重量測定1 */
    private Integer soujyuurousokutei1 = null;

    /** 総重量測定2 */
    private Integer soujyuurousokutei2 = null;

    /** 総重量測定3 */
    private Integer soujyuurousokutei3 = null;

    /** 総重量測定4 */
    private Integer soujyuurousokutei4 = null;

    /** 総重量測定5 */
    private Integer soujyuurousokutei5 = null;

    /** 総重量測定6 */
    private Integer soujyuurousokutei6 = null;

    /** 総重量測定7 */
    private Integer soujyuurousokutei7 = null;

    /** 総重量測定8 */
    private Integer soujyuurousokutei8 = null;

    /** 総重量測定9 */
    private Integer soujyuurousokutei9 = null;

    /** 総重量測定10 */
    private Integer soujyuurousokutei10 = null;

    /** 総重量測定11 */
    private Integer soujyuurousokutei11 = null;

    /** 総重量測定12 */
    private Integer soujyuurousokutei12 = null;

    /** 誘電体ｽﾗﾘｰ重量1 */
    private Integer yuudentaislurryjyuurou1 = null;

    /** 誘電体ｽﾗﾘｰ重量2 */
    private Integer yuudentaislurryjyuurou2 = null;

    /** 誘電体ｽﾗﾘｰ重量3 */
    private Integer yuudentaislurryjyuurou3 = null;

    /** 誘電体ｽﾗﾘｰ重量4 */
    private Integer yuudentaislurryjyuurou4 = null;

    /** 誘電体ｽﾗﾘｰ重量5 */
    private Integer yuudentaislurryjyuurou5 = null;

    /** 誘電体ｽﾗﾘｰ重量6 */
    private Integer yuudentaislurryjyuurou6 = null;

    /** 誘電体ｽﾗﾘｰ重量7 */
    private Integer yuudentaislurryjyuurou7 = null;

    /** 誘電体ｽﾗﾘｰ重量8 */
    private Integer yuudentaislurryjyuurou8 = null;

    /** 誘電体ｽﾗﾘｰ重量9 */
    private Integer yuudentaislurryjyuurou9 = null;

    /** 誘電体ｽﾗﾘｰ重量10 */
    private Integer yuudentaislurryjyuurou10 = null;

    /** 誘電体ｽﾗﾘｰ重量11 */
    private Integer yuudentaislurryjyuurou11 = null;

    /** 誘電体ｽﾗﾘｰ重量12 */
    private Integer yuudentaislurryjyuurou12 = null;

    /** 誘電体ｽﾗﾘｰ重量合計 */
    private Integer yuudentaislurryjyuurougoukei = null;

    /** 投入量 */
    private String tounyuuryou = "";

    /** 歩留まり計算 */
    private BigDecimal budomarikeisan = null;
    ...
    /** 保存用ｻﾝﾌﾟﾙ回収 */
    private String hozonyousamplekaisyu = "";

    /** 分析用ｻﾝﾌﾟﾙ回収 */
    private String zunsekiyousamplekaisyu = "";

    /** 乾燥皿 */
    private String kansouzara = "";

    /** ｱﾙﾐ皿風袋重量 */
    private Integer arumizarafuutaijyuuryou = null;

    /** ｽﾗﾘｰｻﾝﾌﾟﾙ重量規格 */
    private String slurrysamplejyuuryoukikaku = "";

    /** 乾燥前ｽﾗﾘｰ重量 */
    private Integer kansoumaeslurryjyuuryou = null;
    ...
    /** 乾燥後正味重量 */
    private BigDecimal kansougosyoumijyuuryou = null;
     ...
     */
    public String getHozonyousamplekaisyu() {
     ...
     */
    public void setHozonyousamplekaisyu(String hozonyousamplekaisyu) {
     ...
     */
    public String getZunsekiyousamplekaisyu() {
     ...
     */
    public void setZunsekiyousamplekaisyu(String zunsekiyousamplekaisyu) {
