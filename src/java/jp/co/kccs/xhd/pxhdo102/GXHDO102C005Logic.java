 ...
 */
/**
 * GXHDO102C005Logic(添加材ｽﾗﾘｰ作製・溶剤調合入力)ロジッククラス
 * 
 * @author KCSS wxf
 * @since 2021/10/15
 */
public class GXHDO102C005Logic implements Serializable {
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力画面のモデルデータを作成する
     *
     * @param subSrTenkaYouzaiList 添加材ｽﾗﾘｰ作製・溶剤調合入力_ｻﾌﾞ画面データリスト
     * @return モデルデータ
     */
    public static GXHDO102C005Model createGXHDO102C005Model(List<SubSrTenkaYouzai> subSrTenkaYouzaiList) {

        GXHDO102C005Model gxhdo102C005Model = new GXHDO102C005Model();
        gxhdo102C005Model.setShowsubgamendata(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen1(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen2(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen3(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen4(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen5(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen6(gxhdo102C005Model.new SubGamenData());
        gxhdo102C005Model.setSubgamen7(gxhdo102C005Model.new SubGamenData());

        // 分散材1_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen1(), subSrTenkaYouzaiList.get(0));
        // 分散材2_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen2(), subSrTenkaYouzaiList.get(1));
        // 溶剤1_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen3(), subSrTenkaYouzaiList.get(2));
        // 溶剤2_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen4(), subSrTenkaYouzaiList.get(3));
        // 溶剤3_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen5(), subSrTenkaYouzaiList.get(4));
        // 溶剤4_材料品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen6(), subSrTenkaYouzaiList.get(5));
        // ｶﾞﾗｽｽﾗﾘｰ品名のﾘﾝｸから遷移したｻﾌﾞ画面の初期データ設定
        setSubGamenInitData(gxhdo102C005Model.getSubgamen7(), subSrTenkaYouzaiList.get(6));
        return gxhdo102C005Model;
    }

    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力_サブ画面の初期データ設定
     *
     * @param gxhdo102C005Model モデルデータ
     * @param subgamenData 添加材ｽﾗﾘｰ作製・溶剤調合入力_ｻﾌﾞ画面初期データ
     */
    private static void setSubGamenInitData(GXHDO102C005Model.SubGamenData subgamendata, SubSrTenkaYouzai subSrTenkaYouzaiData) {
        // サブ画面の調合規格と調合残量のデータ設定
        ArrayList<FXHDD01> subgamenDataHeaderList = getSubHeaderInfo(subSrTenkaYouzaiData);
        ...
        // サブ画面の部材①タブデータリスト設定
        subgamendata.setSubDataBuzaitab1(getSubTab1Info(subSrTenkaYouzaiData));
        // サブ画面の部材②タブデータリスト設定
        subgamendata.setSubDataBuzaitab2(getSubTab2Info(subSrTenkaYouzaiData));
    }

    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力_サブ画面の調合規格と調合残量のデータ取得
     *
     * @param subSrTenkaYouzaiData 添加材ｽﾗﾘｰ作製・溶剤調合入力_ｻﾌﾞ画面データ
     * @return 調合規格と調合残量のデータリスト
     */
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrTenkaYouzai subSrTenkaYouzaiData) {
     ...
     */
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrTenkaYouzai subSrTenkaYouzaiData) {
        int index = 1;
        // サブ画面の部材①タブデータリスト
        ...
        index += 1;
        // サブ画面の部材①タブの調合量1_2
        subDataBuzaitab1.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou1_2()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材①タブの調合量1_3
        subDataBuzaitab1.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou1_3()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材①タブの調合量1_4
        subDataBuzaitab1.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou1_4()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材①タブの調合量1_5
        subDataBuzaitab1.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou1_5()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材①タブの調合量1_6
        subDataBuzaitab1.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou1_6()), "5", "", true, "g", index));
     ...
     * @return サブ画面のタブデータリスト
     */
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrTenkaYouzai subSrTenkaYouzaiData) {
        int index = 1;
        // サブ画面の部材②タブデータリスト
        ...
        index += 1;
        // サブ画面の部材②タブの調合量2_2
        subDataBuzaitab2.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou2_2()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材②タブの調合量2_3
        subDataBuzaitab2.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou2_3()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材②タブの調合量2_4
        subDataBuzaitab2.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou2_4()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材②タブの調合量2_5
        subDataBuzaitab2.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou2_5()), "5", "", true, "g", index));
        index += 1;
        // サブ画面の部材②タブの調合量2_6
        subDataBuzaitab2.add(setInputNumberInitInfo(true, "", true, StringUtil.nullToBlank(subSrTenkaYouzaiData.getTyougouryou2_6()), "5", "", true, "g", index));
        return subDataBuzaitab2;
    }

    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力画面のラベル項目の属性を設定
     *
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力画面の入力文字列項目の属性を設定
     *
     * @param label1 表示ﾗﾍﾞﾙ1
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力画面の入力数値項目の属性を設定
     *
     * @param render1 表示ﾗﾍﾞﾙ1render有無
     * @param label1 表示ﾗﾍﾞﾙ1
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力_サブ画面の調合残量の計算
     *
     * @param gxhdo102c005model モデルデータ
     */
    public static void calcTyogouzanryou(GXHDO102C005Model gxhdo102c005model) {
        GXHDO102C005Model.SubGamenData showsubgamendata = gxhdo102c005model.getShowsubgamendata();
        // ｻﾌﾞ画面の調合残量の計算
     ...
     */
    private static void setTyogouzanryouValue(GXHDO102C005Model.SubGamenData subgamendata) {
        // サブ画面の調合規格
    ...
    /**
     * 添加材ｽﾗﾘｰ作製・溶剤調合入力_サブ画面の調合量X_1～調合量X_6のリストを取得
     *
     ...
     * 背景色のクリア処理
     *
     * @param gxhdo102c005model 添加材ｽﾗﾘｰ作製・溶剤調合入力サブ画面用ﾓﾃﾞﾙ
     */
    public static void clearBackColor(GXHDO102C005Model gxhdo102c005model) {
        GXHDO102C005Model.SubGamenData showsubgamendata = gxhdo102c005model.getShowsubgamendata();
        // ｻﾌﾞ画面の背景色のクリア処理
     ...
     * @param subgamendata サブ画面のデータ
     */
    public static void clearSubGamenBackColor(GXHDO102C005Model.SubGamenData subgamendata) {
        // サブ画面の部材①タブ
     ...
     */
    public static void setReturnData(GXHDO102C005Model gxhdo102c005model, List<FXHDD01> itemList) {
        GXHDO102C005Model.SubGamenData showsubgamendata = gxhdo102c005model.getShowsubgamendata();
        Integer subDataZairyokubun = showsubgamendata.getSubDataZairyokubun();
        GXHDO102C005Model.SubGamenData subgamendata = getC005subgamendata(gxhdo102c005model, subDataZairyokubun);
     ...
     * @param subgamendata サブ画面のデータ
     */
    public static void setReturnDataFromSubGamen(List<FXHDD01> itemList, GXHDO102C005Model.SubGamenData subgamendata) {
     ...
     * @return サブ画面データ情報
     */
    public static GXHDO102C005Model.SubGamenData getC005subgamendata(GXHDO102C005Model gxhdo102c005model, int zairyokubun) {
        GXHDO102C005Model.SubGamenData subgamendata = null;
        switch (zairyokubun) {
            case 1:
                subgamendata = gxhdo102c005model.getSubgamen1();
                break;
            case 2:
                subgamendata = gxhdo102c005model.getSubgamen2();
                break;
            case 3:
                subgamendata = gxhdo102c005model.getSubgamen3();
                break;
            case 4:
                subgamendata = gxhdo102c005model.getSubgamen4();
                break;
            case 5:
                subgamendata = gxhdo102c005model.getSubgamen5();
                break;
            case 6:
                subgamendata = gxhdo102c005model.getSubgamen6();
                break;
            case 7:
                subgamendata = gxhdo102c005model.getSubgamen7();
                break;
            default:
                break;
        }
     ...
     *
     * @param gxhdo102c005modelview モデルデータ(表示制御用)
     * @param gxhdo102c005model モデルデータ
     */
    public static void setShowsubgamendataFromView(GXHDO102C005Model gxhdo102c005modelview, GXHDO102C005Model gxhdo102c005model) {
        GXHDO102C005Model.SubGamenData showsubgamendata = gxhdo102c005modelview.getShowsubgamendata();
        gxhdo102c005model.setShowsubgamendata(showsubgamendata);
    }
     ...
     * @param gxhdo102c005model モデルデータ
     */
    public static void setSubgamenDataFromView(GXHDO102C005Model gxhdo102c005modelview, GXHDO102C005Model gxhdo102c005model) {
        GXHDO102C005Model.SubGamenData showsubgamendata = gxhdo102c005modelview.getShowsubgamendata();
        Integer zairyokubun = showsubgamendata.getSubDataZairyokubun();
        switch (zairyokubun) {
            case 1:
                gxhdo102c005model.setSubgamen1(showsubgamendata);
                break;
            case 2:
                gxhdo102c005model.setSubgamen2(showsubgamendata);
                break;
            case 3:
                gxhdo102c005model.setSubgamen3(showsubgamendata);
                break;
            case 4:
                gxhdo102c005model.setSubgamen4(showsubgamendata);
                break;
            case 5:
                gxhdo102c005model.setSubgamen5(showsubgamendata);
                break;
            case 6:
                gxhdo102c005model.setSubgamen6(showsubgamendata);
                break;
            case 7:
                gxhdo102c005model.setSubgamen7(showsubgamendata);
                break;
            default:
                break;
        }
