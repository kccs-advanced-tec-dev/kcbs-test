        ...
        switch (process) {
            case "initial":
                activeIdList.addAll(Arrays.asList(
                        ...
                        GXHDO101B002Const.BTN_DOWN_KENSAKU,
                        ...
                        GXHDO101B002Const.BTN_DOWN_WIP_TORIKOMI,
                        GXHDO101B002Const.BTN_UP_KARI_TOUROKU,
                        GXHDO101B002Const.BTN_UP_KENSAKU,
                        ...
                        GXHDO101B002Const.BTN_UP_WIP_TORIKOMI
                ));
...
//                        "syosei_sakujo_Top", "syosei_sakujo_Bottom"));
    ...
    public String convertButtonIdToMethod(String buttonId) {
        ...
        switch (buttonId) {
            // WIP取込
            case GXHDO101B002Const.BTN_UP_WIP_TORIKOMI:
            case GXHDO101B002Const.BTN_DOWN_WIP_TORIKOMI:
                method = "wipImport";
                break;
            // 膜圧
            ...
            case GXHDO101B002Const.BTN_DOWN_TOUROKU:
                ...
                break;
            // 検索
            case GXHDO101B002Const.BTN_UP_KENSAKU:
            case GXHDO101B002Const.BTN_DOWN_KENSAKU:
                method = "doSearch";
                break;
            // 修正
    ...
    private ProcessData setInitDate(ProcessData processData) throws SQLException {
        ...
        // ロットNo
        this.setItemData(processData, GXHDO101B002Const.LOTNO, StringUtil.nullToBlank(lotNo));
        // KCPNO
        this.setItemData(processData, GXHDO101B002Const.KCPNO, "");
        // セット数
        this.setItemData(processData, GXHDO101B002Const.SET_SUU, StringUtil.nullToBlank(sekkeiData.get("SETSUU")));
        // 客先
        this.setItemData(processData, GXHDO101B002Const.KYAKUSAKI, StringUtil.nullToBlank(sekkeiData.get("TOKUISAKI")));
        // ロット区分
        this.setItemData(processData, GXHDO101B002Const.LOT_KUBUN, lotKubunCode + ":" + StringUtil.nullToBlank(lotKbnMasData.get("lotkubun")));
        // オーナー
        this.setItemData(processData, GXHDO101B002Const.OWNER, ownerCode + ":" + StringUtil.nullToBlank(ownerMasData.get("owner")));
        // 電極テープ
        this.setItemData(processData, GXHDO101B002Const.DENKYOKU_TAPE, StringUtil.nullToBlank(ownerMasData.get("GENRYOU"))
                + "  " + StringUtil.nullToBlank(ownerMasData.get("ETAPE")));
        // 積層数
        this.setItemData(processData, GXHDO101B002Const.SEKISOU_SU, StringUtil.nullToBlank(ownerMasData.get("EATUMI"))
                + "μm×"
        ...
        //TODO
        // 上カバーテープ１
        this.setItemData(processData, GXHDO101B002Const.UE_COVER_TAPE1, StringUtil.nullToBlank(ownerMasData.get("TBUNRUI2"))
                + "-"
        ...
        //TODO
        // 下カバーテープ１
        this.setItemData(processData, GXHDO101B002Const.SHITA_COVER_TAPE1, StringUtil.nullToBlank(ownerMasData.get("TBUNRUI4"))
                + "-"
        ...
        //TODO
        // カバーテープ
        this.setItemData(processData, GXHDO101B002Const.COVER_TAPE, "");
        //TODO
        // 列 × 行
        this.setItemData(processData, GXHDO101B002Const.RETSU_GYOU, "");
        //TODO
        // ピッチ
        this.setItemData(processData, GXHDO101B002Const.PITCH, "");
