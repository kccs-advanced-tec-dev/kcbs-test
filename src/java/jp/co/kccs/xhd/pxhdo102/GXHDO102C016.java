 ...
 */
/**
 * GXHDO102C016(ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力)
 *
 * @author KCSS K.Jo
 * @since  2021/12/14
 */
@ManagedBean(name = "beanGXHDO102C016")
@SessionScoped
public class GXHDO102C016 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(GXHDO102C016.class.getName());
    ...
    /**
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ
     */
    private GXHDO102C016Model gxhdO102c016Model;

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ(表示制御用)
     */
    private GXHDO102C016Model gxhdO102c016ModelView;
    ...
    public void doOk() {
        ...
        GXHDO102C016Logic.setSubgamenDataFromView(this.getGxhdO102c016ModelView(), this.getGxhdO102c016Model());
    }
    ...
    private boolean checkOK() {
        ...
        GXHDO102C016Model.SubGamenData showsubgamendata = this.getGxhdO102c016ModelView().getShowsubgamendata();
        // 背景色をクリア
        GXHDO102C016Logic.clearBackColor(this.getGxhdO102c016ModelView());
        setErrorTabIndex(0);
        // サブ画面の部材①タブデータリスト
        ...
        FXHDD01 subDataTyogouryoukikaku = this.getGxhdO102c016ModelView().getShowsubgamendata().getSubDataTyogouryoukikaku();
    ...
    /**
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力_サブ画面の調合残量計算処理
     *
     */
    public void doTyogouzanryouKeisan() {
        //サブ画面の調合残量の計算処理
        GXHDO102C016Logic.calcTyogouzanryou(this.getGxhdO102c016ModelView());
        GXHDO102C016Logic.setShowsubgamendataFromView(this.getGxhdO102c016ModelView(), this.getGxhdO102c016Model());
    }
    ...
    private boolean buzainoCheck(FXHDD01 itemBuzaino, String subTabNo) {
        // 部材在庫品名の値をクリア
        setBuzaihinmeiVal(this.getGxhdO102c016ModelView(), subTabNo, "");
        ...
        setBuzaihinmeiVal(this.getGxhdO102c016ModelView(), subTabNo, hinmei);
     ...
     * @param hinmei 在庫品名
     */
    private void setBuzaihinmeiVal(GXHDO102C016Model gxhdo102c016model, String subTabNo, String hinmei) {
     ...
     * エラーセット
     *
     * @param itemData ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面
     * @param errorId エラーID
     ...
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ
     *
     * @return the gxhdO102c016Model
     */
    public GXHDO102C016Model getGxhdO102c016Model() {
     ...
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ
     *
     * @param gxhdO102c016Model the gxhdO102c016Model to set
     */
    public void setGxhdO102c016Model(GXHDO102C016Model gxhdO102c016Model) {
        this.gxhdO102c016Model = gxhdO102c016Model;
    }

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ(表示制御用)
     *
     * @return the gxhdO102c016ModelView
     */
    public GXHDO102C016Model getGxhdO102c016ModelView() {
        return gxhdO102c016ModelView;
    }

    /**
     * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定入力サブ画面用データ(表示制御用)
     *
     * @param gxhdO102c016ModelView the gxhdO102c016ModelView to set
     */
    public void setGxhdO102c016ModelView(GXHDO102C016Model gxhdO102c016ModelView) {
        this.gxhdO102c016ModelView = gxhdO102c016ModelView;
    }
}
