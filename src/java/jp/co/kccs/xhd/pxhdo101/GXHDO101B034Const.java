 ...
 */
/**
 * GXHDO101B034Const(外部電極洗浄(超音波))定数
 *
 * @author 863 F.Zhang
 * @since  2019/10/18
 */
public class GXHDO101B034Const {
    /**
     * ﾛｯﾄNo.
     */
    public static final String LOTNO = "sr_gdsenjou_lotno";

    /**
     * KCPNO
     */
    public static final String KCPNO = "sr_gdsenjou_kcpno";

    /**
     * 客先
     */
    public static final String KYAKUSAKI = "sr_gdsenjou_kyakusaki";

    /**
     * ﾛｯﾄ区分
     */
    public static final String LOT_KUBUN = "sr_gdsenjou_lot_kubun";

    /**
     * ｵｰﾅｰ
     */
    public static final String OWNER = "sr_gdsenjou_owner";
    
    /**
     * ﾛｯﾄﾌﾟﾚ
     */
    public static final String LOTPRE = "sr_gdsenjou_lotpre";
     ...
     * 備考1
     */
    public static final String BIKO1 = "sr_gdsenjou_biko1";
     ...
     * 枝番コピー(画面上)
     */
    public static final String BTN_EDABAN_COPY_TOP = "sr_gdsenjou_copy_edaban_Top";

    /**
     * 登録(画面上)
     */
    public static final String BTN_INSERT_TOP = "sr_gdsenjou_insert_Top";

    /**
     * 修正(画面上)
     */
    public static final String BTN_UPDATE_TOP = "sr_gdsenjou_update_Top";
     ...
     * 仮登録(画面下)
     */
    public static final String BTN_KARI_TOUROKU_BOTTOM = "sr_gdsenjou_kari_touroku_Bottom";

    /**
     * 枝番コピー(画面下)
     */
    public static final String BTN_EDABAN_COPY_BOTTOM = "sr_gdsenjou_copy_edaban_Bottom";

    /**
     * 登録(画面下)
     */
    public static final String BTN_INSERT_BOTTOM = "sr_gdsenjou_insert_Bottom";

    /**
     * 修正(画面下)
     */
    public static final String BTN_UPDATE_BOTTOM = "sr_gdsenjou_update_Bottom";
     ...
     * ユーザー認証パラメータ(修正)
     */
    public static final String USER_AUTH_UPDATE_PARAM = "sr_gdsenjou_update_button";

    /**
     * ユーザー認証パラメータ(削除)
     */
    public static final String USER_AUTH_DELETE_PARAM = "sr_gdsenjou_delete_button";
}
