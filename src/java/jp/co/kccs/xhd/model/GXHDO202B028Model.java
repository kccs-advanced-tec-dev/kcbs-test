 ...
 */
/**
 * ｽﾘｯﾌﾟ作製・ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/12/25
 */
public class GXHDO202B028Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** ｽﾗﾘｰLotNo */
    private Integer slurrylotno = null;

    /** 容器No */
    private Integer youkino = null;
    ...
    /** ｽﾘｯﾌﾟ情報_風袋重量 */
    private Integer slipjyouhou_fuutaijyuuryou = null;

    /** 総重量 */
    private Integer slurrysoujyuuryou = null;

    /** ｽﾗﾘｰ重量 */
    private Integer slurryjyuuryou = null;
    ...
    /** 固形分測定_風袋重量 */
    private BigDecimal kokeibunsokutei_fuutaijyuuryou = null;

    /** 乾燥前ｽﾗﾘｰ重量 */
    private BigDecimal kansoumaeslurryjyuuryou = null;
    ...
    /** 2回目撹拌開始日時 */
    private Timestamp nikaimekakuhankaisinichiji = null;

    /** 2回目撹拌終了日時 */
    private Timestamp nikaimekakuhansyuuryounichiji = null;

    /** 2回目脱脂皿の種類 */
    private String nikaimedassizaranosyurui = "";

    /** 2回目ｱﾙﾐ皿風袋重量 */
    private BigDecimal nikaimearumizarafuutaijyuuryou = null;

    /** 2回目乾燥前ｽﾗﾘｰ重量 */
    private BigDecimal nikaimekansoumaeslurryjyuuryou = null;
    ...
    /** 2回目乾燥開始日時 */
    private Timestamp nikaimekansoukaisinichij = null;

    /** 2回目乾燥終了日時 */
    private Timestamp nikaimekansousyuuryounichiji = null;

    /** 2回目乾燥後総重量 */
    private BigDecimal nikaimekansougosoujyuuryou = null;

    /** 2回目乾燥後正味重量 */
    private BigDecimal nikaimekansougosyoumijyuuryou = null;

    /** 2回目固形分比率 */
    private BigDecimal nikaimekokeibunhiritu = null;

    /** 2回目固形分測定担当者 */
    private String nikaimekokeibunsokuteitantousya = "";

    /** 2回目溶剤調整量 */
    private Integer nikaimeyouzaityouseiryou = null;

    /** 2回目ﾄﾙｴﾝ調整量 */
    private Integer nikaimetoluenetyouseiryou = null;

    /** 2回目ｿﾙﾐｯｸｽ調整量 */
    private Integer nikaimesolmixtyouseiryou = null;

    /** 2回目溶剤秤量日時 */
    private Timestamp nikaimeyouzaikeiryounichiji = null;
    ...
    /** 2回目溶剤①_調合量1 */
    private Integer nikaimeyouzai1_tyougouryou1 = null;

    /** 2回目溶剤①_部材在庫No2 */
    private String nikaimeyouzai1_buzaizaikolotno2 = "";

    /** 2回目溶剤①_調合量2 */
    private Integer nikaimeyouzai1_tyougouryou2 = null;
    ...
    /** 2回目溶剤②_調合量1 */
    private Integer nikaimeyouzai2_tyougouryou1 = null;

    /** 2回目溶剤②_部材在庫No2 */
    private String nikaimeyouzai2_buzaizaikolotno2 = "";

    /** 2回目溶剤②_調合量2 */
    private Integer nikaimeyouzai2_tyougouryou2 = null;
    ...
    /** 3回目撹拌開始日時 */
    private Timestamp sankaimekakuhankaisinichiji = null;

    /** 3回目撹拌終了日時 */
    private Timestamp sankaimekakuhansyuuryounichiji = null;

    /** 3回目脱脂皿の種類 */
    private String sankaimedassizaranosyurui = "";

    /** 3回目ｱﾙﾐ皿風袋重量 */
    private BigDecimal sankaimearumizarafuutaijyuuryou = null;

    /** 3回目乾燥前ｽﾗﾘｰ重量 */
    private BigDecimal sankaimekansoumaeslurryjyuuryou = null;
    ...
    /** 3回目乾燥開始日時 */
    private Timestamp sankaimekansoukaisinichij = null;

    /** 3回目乾燥終了日時 */
    private Timestamp sankaimekansousyuuryounichiji = null;

    /** 3回目乾燥後総重量 */
    private BigDecimal sankaimekansougosoujyuuryou = null;

    /** 3回目乾燥後正味重量 */
    private BigDecimal sankaimekansougosyoumijyuuryou = null;

    /** 3回目固形分比率 */
    private BigDecimal sankaimekokeibunhiritu = null;

    /** 3回目固形分測定担当者 */
    private String sankaimekokeibunsokuteitantousya = "";

    /** F/P準備_風袋重量 */
    private Integer fpjyunbi_fuutaijyuuryou = null;
    ...
    /** 圧送ﾚｷﾞｭﾚｰﾀｰNo */
    private Integer assouregulatorno = null;
    ...
    /** 正味重量 */
    private BigDecimal syoumijyuuryou = null;
