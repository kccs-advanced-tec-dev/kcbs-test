            ...
            if(null != cmbKotei)switch (cmbKotei) {
                ...
                case "ｽﾗﾘｰ固形分調整(ｽﾃﾝ容器)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", (CASE WHEN assoutanknosenjyou = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS assoutanknosenjyou "
                ...
                case "溶剤秤量・投入(白ﾎﾟﾘ)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", kongoutanksyurui"
                            + ", kongoutankno"
                            + ", (CASE WHEN tanknaisenjyoukakunin = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tanknaisenjyoukakunin "
                            + ", (CASE WHEN tanknaiutibukurokakunin = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tanknaiutibukurokakunin "
                            + ", (CASE WHEN kakuhanhanesenjyoukakunin = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS kakuhanhanesenjyoukakunin "
                            + ", (CASE WHEN kakuhanjikusenjyoukakunin = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS kakuhanjikusenjyoukakunin "
                            + ", (CASE WHEN tounyuu1 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu1 "
                            + ", (CASE WHEN tounyuu2 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu2 "
                            + ", (CASE WHEN tounyuu3 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu3 "
                            + ", (CASE WHEN tounyuu4 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu4 "
                            + ", (CASE WHEN tounyuu5 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu5 "
                            + ", (CASE WHEN tounyuu6 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu6 "
                            + ", slurrytounyuukakuninsya"
                            + ", (CASE WHEN tounyuu7 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu7 "
                            + ", (CASE WHEN tounyuu8 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuu8 "
                ...
                case "溶剤秤量・投入(ｽﾃﾝ容器)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", tantousya"
                            + ", (CASE WHEN yuudentaislurrytounyuu1 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu1 "
                            + ", (CASE WHEN yuudentaislurrytounyuu2 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu2 "
                            + ", (CASE WHEN yuudentaislurrytounyuu3 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu3 "
                            + ", (CASE WHEN yuudentaislurrytounyuu4 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu4 "
                            + ", (CASE WHEN yuudentaislurrytounyuu5 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu5 "
                            + ", (CASE WHEN yuudentaislurrytounyuu6 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS yuudentaislurrytounyuu6 "
                            ...
                            + ", (CASE WHEN kakuhanjikusenjyoukakunin = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS kakuhanjikusenjyoukakunin "
                            + ", tenryuubannotakasa"
                            + ", (CASE WHEN tankniearthgripsetuzoku = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tankniearthgripsetuzoku "
                            + ", (CASE WHEN zunsanzaiyouzaitounyuu = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS zunsanzaiyouzaitounyuu "
                            + ", (CASE WHEN youzaitounyuu1 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS youzaitounyuu1 "
                            + ", (CASE WHEN youzaitounyuu2 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS youzaitounyuu2 "
                ...
                case "ﾊﾞｲﾝﾀﾞｰ秤量・投入":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", (CASE WHEN binderhinmei = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS binderhinmei "
                            + ", binderlotno"
                            + ", binderkokeibun"
                            + ", binderyuukoukigen"
                            + ", bindertenkaryoukikaku"
                            + ", (CASE WHEN hoppersiyou = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS hoppersiyou "
                            + ", tounyuukaisinichiji"
                            + ", tounyuujikaitensuu"
                            + ", hyouryou1"
                            + ", (CASE WHEN tounyuukakunin1 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin1 "
                            + ", hyouryou2"
                            + ", (CASE WHEN tounyuukakunin2 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin2 "
                            + ", hyouryou3"
                            + ", (CASE WHEN tounyuukakunin3 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin3 "
                            + ", hyouryou4"
                            + ", (CASE WHEN tounyuukakunin4 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin4 "
                            + ", hyouryou5"
                            + ", (CASE WHEN tounyuukakunin5 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin5 "
                            + ", hyouryou6"
                            + ", (CASE WHEN tounyuukakunin6 = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tounyuukakunin6 "
                ...
                case "高圧分散":{
                    ...
                    sql ="SELECT CONCAT(SK.kojyo , SK.lotno , SK.edaban) AS lotno "
                            ...
                            + ", (CASE WHEN SK.haisyutsuyoukiuchibukuro = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS haisyutsuyoukiuchibukuro "
                            + ", (CASE WHEN SK.haisyutsuyoukisenjyou = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS haisyutsuyoukisenjyou "
                            + ", (CASE WHEN SK.setsubinaisenjyou = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS setsubinaisenjyou "
                            + ", SK.nozzlekei"
                            + ", SK.reikyakusuivalve"
                            + ", SK.reikyakusuiondokikaku"
                            + ", SK.reikyakusuiondo"
                            + ", SK.kouatsubunsankaisuu"
                            + ", (CASE WHEN SK.tankearthgripsetsuzoku = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS tankearthgripsetsuzoku "
                            + ", SK.bikou1"
                            + ", SK.bikou2 "
                            + "  FROM sr_slip_kouatsubunsan SK "
                            + " INNER JOIN sub_sr_slip_kouatsubunsan SKS "
                ...
                case "FP(ﾊﾞｹﾂ)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", lotkubun"
                            + ", genryoukigou"
                            + ", (CASE WHEN haisyutsuyouki = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS haisyutsuyouki "
                            + ", hutaijyuuryou1"
                            + ", hutaijyuuryou2"
                            + ", hutaijyuuryou3"
                            + ", hutaijyuuryou4"
                ...
                case "FP(成形ﾀﾝｸ)":{
                    ...
                    sql ="SELECT CONCAT(kojyo , lotno , edaban) AS lotno "
                            ...
                            + ", hutaijyuuryou"
                            + ", seikeitankno"
                            + ", (CASE WHEN seikeitankkabuvalve = 1 THEN 'ﾁｪｯｸ' ELSE '未ﾁｪｯｸ' END) AS seikeitankkabuvalve "
                            + ", hokanyoukijyunbitantousya"
                            + ", filterrenketsu"
                            + ", filtertoritsuke1filterhinmei"
                            + ", filtertoritsukefilterlotno1"
