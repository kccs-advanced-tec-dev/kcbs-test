 ...
 */
/**
 * GXHDO102C015Model(ｽﾘｯﾌﾟ作製・溶剤秤量・投入(ｽﾃﾝ容器)入力サブ画面用)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/12/10
 */
public class GXHDO102C015Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C015Model clone() throws CloneNotSupportedException {
        return (GXHDO102C015Model) super.clone();
    }
    ...
    /**
     * 誘電体ｽﾗﾘｰ_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
