 ...
 */
/**
 * ｽﾘｯﾌﾟ作製・ｽﾘｯﾌﾟ固形分測定履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/12/25
 */
public class GXHDO202B033Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** ﾙﾂﾎﾞ風袋重量 */
    private BigDecimal rutubofuutaijyuuryou = null;

    /** 乾燥前ｽﾘｯﾌﾟ重量 */
    private BigDecimal kansoumaeslipjyuuryou = null;
    ...
    /** 撹拌_撹拌時間 */
    private Integer kakuhan_kakuhanjikan = null;

    /** 撹拌_撹拌開始日時 */
    private Timestamp kakuhan_kakuhankaisinichiji = null;

    /** 開始電流値(A) */
    private BigDecimal kaisidenryuuti = null;

    /** 撹拌_撹拌終了予定日時 */
    private Timestamp kakuhan_kakuhansyuuryouyoteinichiji = null;

    /** 撹拌_撹拌終了日時 */
    private Timestamp kakuhan_kakuhansyuuryounichiji = null;
    ...
    /** 排出前撹拌_撹拌時間 */
    private Integer haisyutumaekakuhan_kakuhanjikan = null;

    /** 排出前撹拌_撹拌開始日時 */
    private Timestamp haisyutumaekakuhan_kakuhankaisinichiji = null;

    /** 排出前撹拌_撹拌終了予定日時 */
    private Timestamp haisyutumaekakuhan_kakuhansyuuryouyoteinichiji = null;

    /** 排出前撹拌_撹拌終了日時 */
    private Timestamp haisyutumaekakuhan_kakuhansyuuryounichiji = null;

    /** 排出前撹拌_撹拌担当者 */
    private String haisyutumaekakuhan_kakuhantantousya = "";

    /** 排出開始日時 */
    private Timestamp haisyutukaisinichiji = null;

    /** 排出終了日時 */
    private Timestamp haisyutusyuuryounichiji = null;
     ...
     */
    public Integer getKakuhan_kakuhanjikan() {
     ...
     */
    public void setKakuhan_kakuhanjikan(Integer kakuhan_kakuhanjikan) {
     ...
     */
    public Integer getHaisyutumaekakuhan_kakuhanjikan() {
     ...
     */
    public void setHaisyutumaekakuhan_kakuhanjikan(Integer haisyutumaekakuhan_kakuhanjikan) {
