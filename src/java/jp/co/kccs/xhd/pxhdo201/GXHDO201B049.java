    ...
    public void selectListData() {
        try {
            ...
            String sql = "SELECT CONCAT(IFNULL(T1.kojyo, ''), IFNULL(T1.lotno, ''), IFNULL(T1.edaban, '')) AS LOTNO "
                    ...
                    + ", T1.bikou1 "
                    + ", T1.bikou2 "
                    + ", IFNULL(T8.jissekino, '') AS tpng1jissekino "
                    + ", IFNULL(T8.kensabi, '') AS tpng1kensabi "
                    ...
                    + ", IFNULL(T8.tpkosuu, '') AS tpng1tpkosuu "
                    + ", IFNULL(T8.ng1kosuu, '') AS tpng1ng1kosuu "
                    + ", IFNULL(T8.nukitorikosuu, '') AS tpng1nukitorikosuu "
                    + ", IFNULL(T8.cap_ir_ngkosuu, '') AS tpng1cap_ir_ngkosuu "
                    + ", IFNULL(T8.shortkosuu, '') AS tpng1shortkosuu "
                    + ", IFNULL(T8.etckosuu, '') AS tpng1etckosuu "
                    ...
                    + ", IFNULL(T9.jissekino, '') AS tpng2jissekino "
                    + ", IFNULL(T9.kensabi, '') AS tpng2kensabi "
                    + ", (CASE WHEN T9.kensasya IS NULL THEN '' WHEN T9.kensasya = '' THEN '' ELSE T9.kensasya END) AS tpng2kensasya "
                    + ", (CASE WHEN T9.kensakubun = '1' THEN '流れ品' WHEN T9.kensakubun = '2' THEN 'バラシ品' ELSE '' END) AS tpng2kensakubun "
                    + ", IFNULL(T9.tpkosuu, '') AS tpng2tpkosuu "
                    + ", IFNULL(T9.ng2kosuu, '') AS tpng2ng2kosuu "
                    + ", IFNULL(T9.nukitorikosuu, '') AS tpng2nukitorikosuu "
                    + ", IFNULL(T9.a_modekosuu, '') AS tpng2a_modekosuu "
                    + ", IFNULL(T9.c_modekosuu, '') AS tpng2c_modekosuu "
                    ...
                    + ", IFNULL(T9.d_modekosuu, '') AS tpng2d_modekosuu "
                    + ", IFNULL(T9.etckosuu, '') AS tpng2etckosuu "
                    + ", IFNULL(T9.dhagarekosuu, '') AS tpng2dhagarekosuu "
                    + ", IFNULL(T9.dkizukosuu, '') AS tpng2dkizukosuu "
                    + ", IFNULL(T9.jcrackkosuu, '') AS tpng2jcrackkosuu "
                    + ", IFNULL(T9.mekkinasikosuu, '') AS tpng2mekkinasikosuu "
                    + ", IFNULL(T9.mekkiukikosuu, '') AS tpng2mekkiukikosuu "
                    + ", IFNULL(T10.jissekino, '') AS tpng1jissekino2 "
                    + ", IFNULL(T10.kensabi, '') AS tpng1kensabi2 "
                    ...
                    + ", IFNULL(T10.tpkosuu, '') AS tpng1tpkosuu2 "
                    + ", IFNULL(T10.ng1kosuu, '') AS tpng1ng1kosuu2 "
                    + ", IFNULL(T10.nukitorikosuu, '') AS tpng1nukitorikosuu2 "
                    + ", IFNULL(T10.cap_ir_ngkosuu, '') AS tpng1cap_ir_ngkosuu2 "
                    + ", IFNULL(T10.shortkosuu, '') AS tpng1shortkosuu2 "
                    + ", IFNULL(T10.etckosuu, '') AS tpng1etckosuu2 "
                    ...
                    + ", IFNULL(T11.jissekino, '') AS tpng2jissekino2 "
                    + ", IFNULL(T11.kensabi, '') AS tpng2kensabi2 "
                    + ", (CASE WHEN T11.kensasya IS NULL THEN '' WHEN T11.kensasya = '' THEN '' ELSE T11.kensasya END) AS tpng2kensasya2 "
                    + ", (CASE WHEN T11.kensakubun = '1' THEN '流れ品' WHEN T11.kensakubun = '2' THEN 'バラシ品' ELSE '' END) AS tpng2kensakubun2 "
                    + ", IFNULL(T11.tpkosuu, '') AS tpng2tpkosuu2 "
                    + ", IFNULL(T11.ng2kosuu, '') AS tpng2ng2kosuu2 "
                    + ", IFNULL(T11.nukitorikosuu, '') AS tpng2nukitorikosuu2 "
                    + ", IFNULL(T11.a_modekosuu, '') AS tpng2a_modekosuu2 "
                    + ", IFNULL(T11.c_modekosuu, '') AS tpng2c_modekosuu2 "
                    ...
                    + ", IFNULL(T11.d_modekosuu, '') AS tpng2d_modekosuu2 "
                    + ", IFNULL(T11.etckosuu, '') AS tpng2etckosuu2 "
                    + ", IFNULL(T11.dhagarekosuu, '') AS tpng2dhagarekosuu2 "
                    + ", IFNULL(T11.dkizukosuu, '') AS tpng2dkizukosuu2 "
                    + ", IFNULL(T11.jcrackkosuu, '') AS tpng2jcrackkosuu2 "
                    + ", IFNULL(T11.mekkinasikosuu, '') AS tpng2mekkinasikosuu2 "
                    + ", IFNULL(T11.mekkiukikosuu, '') AS tpng2mekkiukikosuu2 "
                    + ", IFNULL(T12.jissekino, '') AS tpng1jissekino3 "
                    + ", IFNULL(T12.kensabi, '') AS tpng1kensabi3 "
                    ...
                    + ", IFNULL(T12.tpkosuu, '') AS tpng1tpkosuu3 "
                    + ", IFNULL(T12.ng1kosuu, '') AS tpng1ng1kosuu3 "
                    + ", IFNULL(T12.nukitorikosuu, '') AS tpng1nukitorikosuu3 "
                    + ", IFNULL(T12.cap_ir_ngkosuu, '') AS tpng1cap_ir_ngkosuu3 "
                    + ", IFNULL(T12.shortkosuu, '') AS tpng1shortkosuu3 "
                    + ", IFNULL(T12.etckosuu, '') AS tpng1etckosuu3 "
                    ...
                    + ", IFNULL(T13.jissekino, '') AS tpng2jissekino3 "
                    + ", IFNULL(T13.kensabi, '') AS tpng2kensabi3 "
                    + ", (CASE WHEN T13.kensasya IS NULL THEN '' WHEN T13.kensasya = '' THEN '' ELSE T13.kensasya END) AS tpng2kensasya3 "
                    + ", (CASE WHEN T13.kensakubun = '1' THEN '流れ品' WHEN T13.kensakubun = '2' THEN 'バラシ品' ELSE '' END) AS tpng2kensakubun3 "
                    + ", IFNULL(T13.tpkosuu, '') AS tpng2tpkosuu3 "
                    + ", IFNULL(T13.ng2kosuu, '') AS tpng2ng2kosuu3 "
                    + ", IFNULL(T13.nukitorikosuu, '') AS tpng2nukitorikosuu3 "
                    + ", IFNULL(T13.a_modekosuu, '') AS tpng2a_modekosuu3 "
                    + ", IFNULL(T13.c_modekosuu, '') AS tpng2c_modekosuu3 "
                    ...
                    + ", IFNULL(T13.d_modekosuu, '') AS tpng2d_modekosuu3 "
                    + ", IFNULL(T13.etckosuu, '') AS tpng2etckosuu3 "
                    + ", IFNULL(T13.dhagarekosuu, '') AS tpng2dhagarekosuu3 "
                    + ", IFNULL(T13.dkizukosuu, '') AS tpng2dkizukosuu3 "
                    + ", IFNULL(T13.jcrackkosuu, '') AS tpng2jcrackkosuu3 "
                    + ", IFNULL(T13.mekkinasikosuu, '') AS tpng2mekkinasikosuu3 "
                    + ", IFNULL(T13.mekkiukikosuu, '') AS tpng2mekkiukikosuu3 "
