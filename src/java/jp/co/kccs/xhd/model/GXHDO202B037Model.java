 ...
 */
/**
 * ｽﾘｯﾌﾟ作製・出荷検査履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/12/25
 */
public class GXHDO202B037Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** ﾙﾂﾎﾞ風袋重量 */
    private BigDecimal rutsubohuutaijyuuryou = null;
    ...
    /** 乾燥開始日時① */
    private Timestamp kansoukaishijikan1 = null;

    /** 乾燥終了日時① */
    private Timestamp kansousyuuryoujikan1 = null;
    ...
    /** 乾燥開始日時② */
    private Timestamp kansoukaishijikan2 = null;

    /** 乾燥終了日時② */
    private Timestamp kansousyuuryoujikan2 = null;
    ...
    /** 固形分比率 */
    private BigDecimal kokeibunhiritsu = null;
    ...
    /** 粘度測定結果 */
    private BigDecimal nendosokuteikekka = null;

    /** 温度測定規格 */
    private String ondosokuteikikaku = "";

    /** 温度測定結果 */
    private BigDecimal ondosokuteikekka = null;

    /** 粘度測定担当者 */
    private String nendosokuteitantousya = "";

    /** 収率(%) */
    private BigDecimal syuuritsu = null;

    /** ｽﾘｯﾌﾟ有効期限 */
    private Timestamp slipyuukoukigen = null;
