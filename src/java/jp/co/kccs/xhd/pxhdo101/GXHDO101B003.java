        ...
        switch (process) {
            case "initial":
                activeIdList.addAll(Arrays.asList(
                        ...
                        GXHDO101B003Const.BTN_DOWN_KENSAKU,
                        GXHDO101B003Const.BTN_DOWN_MAKUATSU_SUBGAMEN,
                        GXHDO101B003Const.BTN_DOWN_SAKUJO,
...
//                        "syosei_sakujo_Top", "syosei_sakujo_Bottom"));
    ...
    public String convertButtonIdToMethod(String buttonId) {
        ...
        switch (buttonId) {
            // WIP取込
            case GXHDO101B003Const.BTN_UP_WIP_TORIKOMI:
            case GXHDO101B003Const.BTN_DOWN_WIP_TORIKOMI:
                method = "wipImport";
                break;
            // 膜圧
            ...
            case GXHDO101B003Const.BTN_DOWN_KARI_TOUROKU:
                ...
                break;
            // 登録
            case GXHDO101B003Const.BTN_UP_TOUROKU:
            case GXHDO101B003Const.BTN_DOWN_TOUROKU:
                method = "toroku";
                break;
            // 検索
            case GXHDO101B003Const.BTN_UP_KENSAKU:
            case GXHDO101B003Const.BTN_DOWN_KENSAKU:
                method = "kensaku";
                break;
            // 修正
            case GXHDO101B003Const.BTN_UP_SHUSEI:
            case GXHDO101B003Const.BTN_DOWN_SHUSEI:
                method = "shusei";
                break;
            // 削除
            case GXHDO101B003Const.BTN_UP_SAKUJO:
            case GXHDO101B003Const.BTN_DOWN_SAKUJO:
                method = "sakujo";
                break;
            default:
                method = "error";
    ...
    private ProcessData setInitDate(ProcessData processData) throws SQLException {
        ...
        // ロットNo
        this.setItemData(processData, GXHDO101B003Const.LOTNO, StringUtil.nullToBlank(lotNo));
        // KCPNO
        this.setItemData(processData, GXHDO101B003Const.KCPNO, "");
        // セット数
        this.setItemData(processData, GXHDO101B003Const.SET_SUU, StringUtil.nullToBlank(sekkeiData.get("SETSUU")));
        // 客先
        ...
        //TODO
        // カバーテープ
        this.setItemData(processData, GXHDO101B003Const.COVER_TAPE, "");
        //TODO
        // 列 × 行
        this.setItemData(processData, GXHDO101B003Const.RETSU_GYOU, "");
        //TODO
        // ピッチ
