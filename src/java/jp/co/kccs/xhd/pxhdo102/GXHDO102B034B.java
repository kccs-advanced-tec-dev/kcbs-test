 ...
 */
/**
 * GXHDO102B034B(ｽﾘｯﾌﾟ作製・高圧分散)
 *
 * @author KCSS K.Jo
 * @since 2021/12/20
 */
@ViewScoped
@Named("beanGXHDO102B034B")
public class GXHDO102B034B implements Serializable {

    /**
     * 一覧表示データ
     */
    private List<GXHDO102B034Model> passlistdata;
    ...
    /**
     * 一覧表示データ
     * @return the passlistdata
     */
    public List<GXHDO102B034Model> getPasslistdata() {
        return passlistdata;
    }

    /**
     * 一覧表示データ
     * @param passlistdata the passlistdata to set
     */
    public void setPasslistdata(List<GXHDO102B034Model> passlistdata) {
