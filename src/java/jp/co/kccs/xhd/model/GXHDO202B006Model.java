 ...
 */
/**
 * ｶﾞﾗｽｽﾗﾘ-作製・ﾎﾟｯﾄ粉砕履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2021/09/14
 */
public class GXHDO202B006Model implements Serializable {
    /** WIPﾛｯﾄNo */
    ...
    /** 粉砕回転台号機 */
    private Integer kaitendaigouki = null;

    /** 粉砕開始日時 */
    private Timestamp funsaikaisinichiji = null;

    /** 粉砕終了予定日時 */
    private Timestamp funsaiyoteisyuuryounichiji = null;
    ...
    /** 粉砕時間 */
    private Integer funsaijikan = null;
    ...
    /** 保管開始日時 */
    private Timestamp hokankaisinichiji = null;
