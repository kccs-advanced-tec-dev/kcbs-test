...
public class GXHDO102C006Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrTenkaFunsaiHyoryo subSrTenkaFunsaiHyoryo) {
        ...
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getTyogouryoukikaku()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
        // 【材料品名】ﾘﾝｸ押下時、サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getTyogouzanryou()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
    ...
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrTenkaFunsaiHyoryo subSrTenkaFunsaiHyoryo) {
        ...
        // サブ画面の部材①タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getZairyohinmei()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
        // サブ画面の部材①タブの部材在庫No1
        ...
        // サブ画面の部材①タブの部材在庫品名1
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "1", true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getBuzaihinmei1()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材①タブの調合量1_1
    ...
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrTenkaFunsaiHyoryo subSrTenkaFunsaiHyoryo) {
        ...
        // サブ画面の部材②タブの材料品名
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getZairyohinmei()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
        // サブ画面の部材②タブの部材在庫No1
        ...
        // サブ画面の部材②タブの部材在庫品名1
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "2", true, StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getBuzaihinmei2()), StringUtil.nullToBlank(subSrTenkaFunsaiHyoryo.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材②タブの調合量2_1
