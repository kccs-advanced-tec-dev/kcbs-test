...
public class FXHDD07Json {
    ...
    private String kaisulist;
    private String rirekistartlist;
    private String rirekiendlist;    
    private String bin1lowlist;
    private String bin1highlist;
    private String bin1countersuulist;
    private String bin2lowlist;
    private String bin2highlist;
    private String bin2countersuulist;
    private String bin3lowlist;
    private String bin3highlist;
    private String bin3countersuulist;
    private String bin4lowlist;
    private String bin4highlist;
    private String bin4countersuulist;
    private String bin5lowlist;
    private String bin5highlist;
    private String bin5countersuulist;
    private String bin6lowlist;
    private String bin6highlist;
    private String bin6countersuulist;
    private String bin7lowlist;
    private String bin7highlist;
    private String bin7countersuulist;
    private String bin8lowlist;
    private String bin8highlist;
    private String bin8countersuulist;
    ...
    /**
     * @return the kaisulist
     */
    public String getKaisulist() {
        return kaisulist;
    }

    /**
     * @param kaisulist the kaisulist to set
     */
    public void setKaisulist(String kaisulist) {
        this.kaisulist = kaisulist;
    }

    /**
     * @return the rirekistartlist
     */
    public String getRirekistartlist() {
        return rirekistartlist;
    }

    /**
     * @param rirekistartlist the rirekistartlist to set
     */
    public void setRirekistartlist(String rirekistartlist) {
        this.rirekistartlist = rirekistartlist;
    }

    /**
     * @return the rirekiendlist
     */
    public String getRirekiendlist() {
        return rirekiendlist;
    }

    /**
     * @param rirekiendlist the rirekiendlist to set
     */
    public void setRirekiendlist(String rirekiendlist) {
        this.rirekiendlist = rirekiendlist;
    }

    /**
     * @return the bin1lowlist
     */
    public String getBin1lowlist() {
        return bin1lowlist;
    }

    /**
     * @param bin1lowlist the bin1lowlist to set
     */
    public void setBin1lowlist(String bin1lowlist) {
        this.bin1lowlist = bin1lowlist;
    }

    /**
     * @return the bin1highlist
     */
    public String getBin1highlist() {
        return bin1highlist;
    }

    /**
     * @param bin1highlist the bin1highlist to set
     */
    public void setBin1highlist(String bin1highlist) {
        this.bin1highlist = bin1highlist;
    }

    /**
     * @return the bin1countersuulist
     */
    public String getBin1countersuulist() {
        return bin1countersuulist;
    }

    /**
     * @param bin1countersuulist the bin1countersuulist to set
     */
    public void setBin1countersuulist(String bin1countersuulist) {
        this.bin1countersuulist = bin1countersuulist;
    }

    /**
     * @return the bin2lowlist
     */
    public String getBin2lowlist() {
        return bin2lowlist;
    }

    /**
     * @param bin2lowlist the bin2lowlist to set
     */
    public void setBin2lowlist(String bin2lowlist) {
        this.bin2lowlist = bin2lowlist;
    }

    /**
     * @return the bin2highlist
     */
    public String getBin2highlist() {
        return bin2highlist;
    }

    /**
     * @param bin2highlist the bin2highlist to set
     */
    public void setBin2highlist(String bin2highlist) {
        this.bin2highlist = bin2highlist;
    }

    /**
     * @return the bin2countersuulist
     */
    public String getBin2countersuulist() {
        return bin2countersuulist;
    }

    /**
     * @param bin2countersuulist the bin2countersuulist to set
     */
    public void setBin2countersuulist(String bin2countersuulist) {
        this.bin2countersuulist = bin2countersuulist;
    }

    /**
     * @return the bin3lowlist
     */
    public String getBin3lowlist() {
        return bin3lowlist;
    }

    /**
     * @param bin3lowlist the bin3lowlist to set
     */
    public void setBin3lowlist(String bin3lowlist) {
        this.bin3lowlist = bin3lowlist;
    }

    /**
     * @return the bin3highlist
     */
    public String getBin3highlist() {
        return bin3highlist;
    }

    /**
     * @param bin3highlist the bin3highlist to set
     */
    public void setBin3highlist(String bin3highlist) {
        this.bin3highlist = bin3highlist;
    }

    /**
     * @return the bin3countersuulist
     */
    public String getBin3countersuulist() {
        return bin3countersuulist;
    }

    /**
     * @param bin3countersuulist the bin3countersuulist to set
     */
    public void setBin3countersuulist(String bin3countersuulist) {
        this.bin3countersuulist = bin3countersuulist;
    }

    /**
     * @return the bin4lowlist
     */
    public String getBin4lowlist() {
        return bin4lowlist;
    }

    /**
     * @param bin4lowlist the bin4lowlist to set
     */
    public void setBin4lowlist(String bin4lowlist) {
        this.bin4lowlist = bin4lowlist;
    }

    /**
     * @return the bin4highlist
     */
    public String getBin4highlist() {
        return bin4highlist;
    }

    /**
     * @param bin4highlist the bin4highlist to set
     */
    public void setBin4highlist(String bin4highlist) {
        this.bin4highlist = bin4highlist;
    }

    /**
     * @return the bin4countersuulist
     */
    public String getBin4countersuulist() {
        return bin4countersuulist;
    }

    /**
     * @param bin4countersuulist the bin4countersuulist to set
     */
    public void setBin4countersuulist(String bin4countersuulist) {
        this.bin4countersuulist = bin4countersuulist;
    }

    /**
     * @return the bin5lowlist
     */
    public String getBin5lowlist() {
        return bin5lowlist;
    }

    /**
     * @param bin5lowlist the bin5lowlist to set
     */
    public void setBin5lowlist(String bin5lowlist) {
        this.bin5lowlist = bin5lowlist;
    }

    /**
     * @return the bin5highlist
     */
    public String getBin5highlist() {
        return bin5highlist;
    }

    /**
     * @param bin5highlist the bin5highlist to set
     */
    public void setBin5highlist(String bin5highlist) {
        this.bin5highlist = bin5highlist;
    }

    /**
     * @return the bin5countersuulist
     */
    public String getBin5countersuulist() {
        return bin5countersuulist;
    }

    /**
     * @param bin5countersuulist the bin5countersuulist to set
     */
    public void setBin5countersuulist(String bin5countersuulist) {
        this.bin5countersuulist = bin5countersuulist;
    }

    /**
     * @return the bin6lowlist
     */
    public String getBin6lowlist() {
        return bin6lowlist;
    }

    /**
     * @param bin6lowlist the bin6lowlist to set
     */
    public void setBin6lowlist(String bin6lowlist) {
        this.bin6lowlist = bin6lowlist;
    }

    /**
     * @return the bin6highlist
     */
    public String getBin6highlist() {
        return bin6highlist;
    }

    /**
     * @param bin6highlist the bin6highlist to set
     */
    public void setBin6highlist(String bin6highlist) {
        this.bin6highlist = bin6highlist;
    }

    /**
     * @return the bin6countersuulist
     */
    public String getBin6countersuulist() {
        return bin6countersuulist;
    }

    /**
     * @param bin6countersuulist the bin6countersuulist to set
     */
    public void setBin6countersuulist(String bin6countersuulist) {
        this.bin6countersuulist = bin6countersuulist;
    }

    /**
     * @return the bin7lowlist
     */
    public String getBin7lowlist() {
        return bin7lowlist;
    }

    /**
     * @param bin7lowlist the bin7lowlist to set
     */
    public void setBin7lowlist(String bin7lowlist) {
        this.bin7lowlist = bin7lowlist;
    }

    /**
     * @return the bin7highlist
     */
    public String getBin7highlist() {
        return bin7highlist;
    }

    /**
     * @param bin7highlist the bin7highlist to set
     */
    public void setBin7highlist(String bin7highlist) {
        this.bin7highlist = bin7highlist;
    }

    /**
     * @return the bin7countersuulist
     */
    public String getBin7countersuulist() {
        return bin7countersuulist;
    }

    /**
     * @param bin7countersuulist the bin7countersuulist to set
     */
    public void setBin7countersuulist(String bin7countersuulist) {
        this.bin7countersuulist = bin7countersuulist;
    }

    /**
     * @return the bin8lowlist
     */
    public String getBin8lowlist() {
        return bin8lowlist;
    }

    /**
     * @param bin8lowlist the bin8lowlist to set
     */
    public void setBin8lowlist(String bin8lowlist) {
        this.bin8lowlist = bin8lowlist;
    }

    /**
     * @return the bin8highlist
     */
    public String getBin8highlist() {
        return bin8highlist;
    }

    /**
     * @param bin8highlist the bin8highlist to set
     */
    public void setBin8highlist(String bin8highlist) {
        this.bin8highlist = bin8highlist;
    }

    /**
     * @return the bin8countersuulist
     */
    public String getBin8countersuulist() {
        return bin8countersuulist;
    }

    /**
     * @param bin8countersuulist the bin8countersuulist to set
     */
    public void setBin8countersuulist(String bin8countersuulist) {
        this.bin8countersuulist = bin8countersuulist;
    }
}
