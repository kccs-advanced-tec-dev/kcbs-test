 ...
 */
/**
 * GXHDO102C010Model(誘電体ｽﾗﾘｰ作製・添加材・ｿﾞﾙ秤量入力サブ画面用)のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since 2021/11/10
 */
public class GXHDO102C010Model implements Cloneable {
     ...
     */
    @Override
    public GXHDO102C010Model clone() throws CloneNotSupportedException {
        return (GXHDO102C010Model) super.clone();
    }
    ...
    /**
     * ｿﾞﾙ1_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen6;

    /**
     * ｿﾞﾙ2_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen7;

    /**
     * ｿﾞﾙ3_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
    private SubGamenData subgamen8;

    /**
     * ｿﾞﾙ4_材料品名のﾘﾝｸのﾘﾝｸから遷移したｻﾌﾞ画面用データ
     */
