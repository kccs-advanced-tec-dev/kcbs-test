...
public class GXHDO102C003Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrGlassslurryfunsai subSrGlassslurryfunsai) {
        ...
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(subSrGlassslurryfunsai.getTyogouryoukikaku()), StringUtil.nullToBlank(subSrGlassslurryfunsai.getStandardpattern()), index));
        // 【材料品名1】ﾘﾝｸ押下時、サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(subSrGlassslurryfunsai.getTyogouzanryou()), StringUtil.nullToBlank(subSrGlassslurryfunsai.getStandardpattern()), index));
    ...
    private static ArrayList<FXHDD01> getSubTabInfo(SubSrGlassslurryfunsai subSrGlassslurryfunsai) {
        ...
        // サブ画面の部材タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(subSrGlassslurryfunsai.getZairyohinmei()), StringUtil.nullToBlank(subSrGlassslurryfunsai.getStandardpattern()), index));
        // サブ画面の部材タブの部材在庫No
        ...
        // サブ画面の部材タブの部材在庫品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei"), true, StringUtil.nullToBlank(subSrGlassslurryfunsai.getBuzaihinmei()), StringUtil.nullToBlank(subSrGlassslurryfunsai.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材タブの調合量1
