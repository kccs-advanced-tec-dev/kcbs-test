...
public class GXHDO102C015Logic implements Serializable {
    ...
    private static ArrayList<FXHDD01> getSubHeaderInfo(SubSrSlipYouzaihyouryouTounyuuSutenyouki SubSrSlipYouzaihyouryouTounyuuSutenyoukiList) {
        ...
        int index = 0;
        // サブ画面の調合規格
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouryoukikaku"), true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getTyogouryoukikaku()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
        // サブ画面の調合残量
        subDataHeaderList.add(setLabelInitInfo(true, MessageUtil.getMessage("tyogouzanryou"), true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getTyogouzanryou()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
    ...
    private static ArrayList<FXHDD01> getSubTab1Info(SubSrSlipYouzaihyouryouTounyuuSutenyouki SubSrSlipYouzaihyouryouTounyuuSutenyoukiList) {
        ...
        // サブ画面の部材①タブの材料品名
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getZairyohinmei()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
        // サブ画面の部材①タブの部材在庫No1
        ...
        // サブ画面の部材①タブの部材在庫品名1
        subDataBuzaitab1.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "1", true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getBuzaihinmei1()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材①タブの調合量1_1
    ...
    private static ArrayList<FXHDD01> getSubTab2Info(SubSrSlipYouzaihyouryouTounyuuSutenyouki SubSrSlipYouzaihyouryouTounyuuSutenyoukiList) {
        ...
        // サブ画面の部材②タブの材料品名
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("zairyohinmei"), true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getZairyohinmei()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
        // サブ画面の部材②タブの部材在庫No1
        ...
        // サブ画面の部材②タブの部材在庫品名1
        subDataBuzaitab2.add(setLabelInitInfo(true, MessageUtil.getMessage("buzaihinmei") + "2", true, StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getBuzaihinmei2()), StringUtil.nullToBlank(SubSrSlipYouzaihyouryouTounyuuSutenyoukiList.getStandardpattern()), index));
        index += 1;
        // サブ画面の部材②タブの調合量2_1
