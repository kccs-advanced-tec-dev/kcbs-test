 ...
 */
/**
 * 外部電極・外部電極焼成(樹脂電極硬化)履歴検索画面のモデルクラスです。
 *
 * @author KCSS K.Jo
 * @since  2019/11/06
 */
public class GXHDO201B031Model implements Serializable{
     ...
     * @param ptnno ptnno
     */
    public void setPtnno(Integer ptnno) {
        this.ptnno = ptnno;
    }
